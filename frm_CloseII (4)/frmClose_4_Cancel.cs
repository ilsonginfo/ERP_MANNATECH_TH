...
{
    public partial class frmClose_4_Cancel : Form
    {
        ...
        private void Close_Work_Real(cls_Connect_DB Temp_Connect, SqlConnection Conn, SqlTransaction tran)
        {
           ...
           // StrSql = StrSql + " ,BeShamSell_Pr=ISNULL(B.BeShamSell_Pr,0) ";
            ...
            StrSql = StrSql + " From tbl_ClosePay_04_Sell_Mod ";
            StrSql = StrSql + " Where  ToEndDate ='" + ToEndDate + "'";
            StrSql = StrSql + " ) B";
            ...
            StrSql = StrSql + ",Be_Down_PV_1 = ISNULL(B.Be_Down_PV_1,0) ";
            StrSql = StrSql + ",Be_Down_PV_2 = ISNULL(B.Be_Down_PV_2,0) ";
            ...
            StrSql = StrSql + ",Be_GradeDate12 = ISNULL(B.Be_GradeDate12,'') ";
            StrSql = StrSql + ",Be_GradeDate13 = ISNULL(B.Be_GradeDate13,'') ";
            StrSql = StrSql + ",Be_GradeDate14 = ISNULL(B.Be_GradeDate14,'') ";
            StrSql = StrSql + ",Be_GradeDate15 = ISNULL(B.Be_GradeDate15,'') ";



            StrSql = StrSql + " ,Be_Pay1_Date_80 = ISNULL(B.Be_Pay1_Date_80,'')";
            StrSql = StrSql + " ,Be_Pay1_Date_90 = ISNULL(B.Be_Pay1_Date_90,'')";
            StrSql = StrSql + " ,Be_Pay1_Date_100 = ISNULL(B.Be_Pay1_Date_100,'')";
            StrSql = StrSql + " ,Be_Pay1_Date_110 = ISNULL(B.Be_Pay1_Date_110,'')";
            StrSql = StrSql + " ,Be_Pay1_Date_120 = ISNULL(B.Be_Pay1_Date_120,'')";
            StrSql = StrSql + " ,Be_Pay1_Date_130 = ISNULL(B.Be_Pay1_Date_130,'')";
            StrSql = StrSql + " ,Be_Pay1_Date_140 = ISNULL(B.Be_Pay1_Date_140,'')";
            StrSql = StrSql + " ,Be_Pay1_Date_150 = ISNULL(B.Be_Pay1_Date_150,'')";

            StrSql = StrSql + " ,Be_Pay2_Date_100 = ISNULL(B.Be_Pay2_Date_100,'')";
            StrSql = StrSql + " ,Be_Pay2_Date_110 = ISNULL(B.Be_Pay2_Date_110,'')";
            StrSql = StrSql + " ,Be_Pay2_Date_120= ISNULL(B.Be_Pay2_Date_120,'') ";
            StrSql = StrSql + " ,Be_Pay2_Date_130 = ISNULL(B.Be_Pay2_Date_130,'')";
            StrSql = StrSql + " ,Be_Pay2_Date_140 = ISNULL(B.Be_Pay2_Date_140,'')";
            StrSql = StrSql + " ,Be_Pay2_Date_150 = ISNULL(B.Be_Pay2_Date_150,'')";


            StrSql = StrSql + " FROM  tbl_ClosePay_04  A, ";

            StrSql = StrSql + " (Select Mbid,Mbid2 ";
            StrSql = StrSql + " ,Be_Down_PV_1,Be_Down_PV_2";
            StrSql = StrSql + " , BeforeGrade ";
            ...
            StrSql = StrSql + " ,Be_GradeDate12 ";
            StrSql = StrSql + " ,Be_GradeDate13 ";
            StrSql = StrSql + " ,Be_GradeDate14 ";
            StrSql = StrSql + " ,Be_GradeDate15 ";


            StrSql = StrSql + " ,Be_Pay1_Date_80 ";
            StrSql = StrSql + " ,Be_Pay1_Date_90 ";
            StrSql = StrSql + " ,Be_Pay1_Date_100 ";
            StrSql = StrSql + " ,Be_Pay1_Date_110 ";
            StrSql = StrSql + " ,Be_Pay1_Date_120 ";
            StrSql = StrSql + " ,Be_Pay1_Date_130 ";
            StrSql = StrSql + " ,Be_Pay1_Date_140 ";
            StrSql = StrSql + " ,Be_Pay1_Date_150 ";

            StrSql = StrSql + " ,Be_Pay2_Date_100 ";
            StrSql = StrSql + " ,Be_Pay2_Date_110 ";
            StrSql = StrSql + " ,Be_Pay2_Date_120 ";
            StrSql = StrSql + " ,Be_Pay2_Date_130 ";
            StrSql = StrSql + " ,Be_Pay2_Date_140 ";
            StrSql = StrSql + " ,Be_Pay2_Date_150 ";
            ...
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_GradeDate12");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_GradeDate13");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_GradeDate14");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_GradeDate15");

            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay1_Date_80");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay1_Date_90");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay1_Date_100");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay1_Date_110");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay1_Date_120");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay1_Date_130");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay1_Date_140");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay1_Date_150");

            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay2_Date_100");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay2_Date_110");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay2_Date_120");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay2_Date_130");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay2_Date_140");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Be_Pay2_Date_150");

            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate1");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate2");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate3");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate4");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate5");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate6");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate7");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate8");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate9");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate10");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate11");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate12");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate13");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate14");
            Change_Be_StringField(Temp_Connect, Conn, tran, "Fir_GradeDate15");
            ...
            StrSql = StrSql + " WHERE ToEndDate = '" + ToEndDate + "'";
            StrSql = StrSql + " And  Close_FLAG = 'M'  ";
            StrSql = StrSql + " ) B";
            ...
            StrSql = StrSql + " From tbl_Close_Not_Pay_Cut_Mod (nolock)  ";
            StrSql = StrSql + " WHERE ToEndDate = '" + ToEndDate + "'";
            StrSql = StrSql + " And  Close_FLAG = 'M1'  ";
            StrSql = StrSql + " ) B";
            StrSql = StrSql + " Where A.ToEndDate = B.Cut_ToEndDate ";
            StrSql = StrSql + " And   A.mbid = B.mbid ";
            StrSql = StrSql + " And   A.mbid2 = B.mbid2 ";
            ...
            StrSql = StrSql + " From tbl_Close_Not_Pay_Cut_Mod (nolock)  ";
            StrSql = StrSql + " WHERE ToEndDate = '" + ToEndDate + "'";
            StrSql = StrSql + " And  Close_FLAG = 'M2'  ";
            StrSql = StrSql + " ) B";
            StrSql = StrSql + " Where A.ToEndDate = B.Cut_ToEndDate ";
            StrSql = StrSql + " And   A.mbid = B.mbid ";
            StrSql = StrSql + " And   A.mbid2 = B.mbid2 ";
            ...
            StrSql = StrSql + " From tbl_Close_Not_Pay_Cut_Mod (nolock)  ";
            StrSql = StrSql + " WHERE ToEndDate = '" + ToEndDate + "'";
            StrSql = StrSql + " And  Close_FLAG = 'M3'  ";
            StrSql = StrSql + " ) B";
            StrSql = StrSql + " Where A.ToEndDate = B.Cut_ToEndDate ";
            StrSql = StrSql + " And   A.mbid = B.mbid ";
            StrSql = StrSql + " And   A.mbid2 = B.mbid2 ";
            ...
            StrSql = "Update tbl_ClosePay_04_Mod SET ";
            StrSql = StrSql + " Allowance4 =   Isnull(B.SumAllAllowance,0) ";
            StrSql = StrSql + " FROM  tbl_ClosePay_04_Mod  A, ";

            StrSql = StrSql + " (Select  Cut_ToEndDate, mbid, mbid2,SumAllAllowance  ";
            StrSql = StrSql + " From tbl_Close_Not_Pay_Cut_Mod (nolock)  ";
            StrSql = StrSql + " WHERE ToEndDate = '" + ToEndDate + "'";
            StrSql = StrSql + " And  Close_FLAG = 'M4'  ";
            StrSql = StrSql + " ) B";
            StrSql = StrSql + " Where A.ToEndDate = B.Cut_ToEndDate ";
            StrSql = StrSql + " And   A.mbid = B.mbid ";
            StrSql = StrSql + " And   A.mbid2 = B.mbid2 ";
            ...
            StrSql = "Update tbl_ClosePay_04_Mod SET ";
            StrSql = StrSql + " Allowance5 =   Isnull(B.SumAllAllowance,0) ";
            StrSql = StrSql + " FROM  tbl_ClosePay_04_Mod  A, ";

            StrSql = StrSql + " (Select  Cut_ToEndDate, mbid, mbid2,SumAllAllowance  ";
            StrSql = StrSql + " From tbl_Close_Not_Pay_Cut_Mod (nolock)  ";
            StrSql = StrSql + " WHERE ToEndDate = '" + ToEndDate + "'";
            StrSql = StrSql + " And  Close_FLAG = 'M5'  ";
            StrSql = StrSql + " ) B";
            StrSql = StrSql + " Where A.ToEndDate = B.Cut_ToEndDate ";
            StrSql = StrSql + " And   A.mbid = B.mbid ";
            StrSql = StrSql + " And   A.mbid2 = B.mbid2 ";
            ...
            StrSql = "Update tbl_ClosePay_04_Mod SET ";
            StrSql = StrSql + " Allowance6 =   Isnull(B.SumAllAllowance,0) ";
            StrSql = StrSql + " FROM  tbl_ClosePay_04_Mod  A, ";

            StrSql = StrSql + " (Select  Cut_ToEndDate, mbid, mbid2,SumAllAllowance  ";
            StrSql = StrSql + " From tbl_Close_Not_Pay_Cut_Mod (nolock)  ";
            StrSql = StrSql + " WHERE ToEndDate = '" + ToEndDate + "'";
            StrSql = StrSql + " And  Close_FLAG = 'M6'  ";
            StrSql = StrSql + " ) B";
            StrSql = StrSql + " Where A.ToEndDate = B.Cut_ToEndDate ";
            StrSql = StrSql + " And   A.mbid = B.mbid ";
            StrSql = StrSql + " And   A.mbid2 = B.mbid2 ";
            ...
            StrSql = "Delete From tbl_Close_Not_Pay_Cut_Mod Where ToEndDate = '" + ToEndDate + "' And LEFT(Close_FLAG,1) = 'M' ";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            ...
            StrSql = "Update tbl_Close_Not_Pay_04 SET Ap_ToEnddate = ''  ";
            StrSql = StrSql + " Where Ap_ToEndDate = '" + ToEndDate + "'";
            ...
            StrSql = "Delete From tbl_Close_Not_Pay_04  Where  ToEndDate  = '" + ToEndDate + "'";
            //tbl_Close_Not_Pay_04
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg1.PerformStep(); pg1.Refresh();


            StrSql = "Delete From tbl_ClosePay_04_Bus_Mod  Where  ToEndDate  = '" + ToEndDate + "'";

            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg1.PerformStep(); pg1.Refresh();

            StrSql = "Delete From tbl_Close_DownPV_PV_04_Nom  Where  EndDate  = '" + ToEndDate + "'";
            ...
            StrSql = "Delete From tbl_Close_DownPV_PV_04_130P Where EndDate = '" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            


            StrSql = "Delete From tbl_ClosePay_04_Pay1_Mod Where ToEndDate = '" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg1.PerformStep(); pg1.Refresh();
