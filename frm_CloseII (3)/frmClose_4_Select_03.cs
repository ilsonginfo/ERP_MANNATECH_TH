...
namespace MLM_Program
{
    public partial class frmClose_4_Select_03 : Form
    {
        ...
        private void Make_Base_Query(ref string Tsql)
        {
            ...
            Tsql = Tsql + " , Case When ReqTF8 >= ReqTF7  then ISnull(C8.Grade_Name,'') eLSE ISnull(C7.Grade_Name,'') end   "; //프로모션직급
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = {"_선택","회원번호", "성명", "_마감주차","마감_시작일"  
                                ...
                                , "이전_좌" , "이전_우" ,"합산_좌",  "합산_우"  ,"이월_좌"
                                ,"이월_우", "130팩직추천수","_반품전공제2",  "_직급_4주합산좌" ,"_직급_4주합산우"


                                ,"_유지여부"    , "_4주본인"   , "_4주ADS" , "_4주직추멤버" , "프로모션직급"

                                , "기타보너스" ,"승급보너스골드이하"   , "승급보너스1차" , "승급보너스2차"     , "성취보너스"    
                                , "액티브보너스"   , "센터보너스" , "프로모션"     , "_리더십보너스"    , "_PB보너스"     
        ...
        private void put_Sum_Dataview(DataSet ds, int ReCnt)
        {
            ...
            for (int fi_cnt = 0; fi_cnt <= ReCnt - 1; fi_cnt++)
            {
                ...
                Sum_dic["프로모션"] = Sum_dic["프로모션"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance7"].ToString());
        ...
        private void Allowance_Detail(string T_Mbid, string ToEndDate)
        {
            ...
            dGridView_Base_Header_Reset(dGridView_Pay_130P, cgb_P1, 11); //디비그리드 헤더와 기본 셋팅을 한다.
            cgb_P1.d_Grid_view_Header_Reset();
            Real_Allowance_Detail_Nom_130(ToEndDate, Mbid, Mbid2, 3, cgb_P1);  //판매내역 역추적
        }
