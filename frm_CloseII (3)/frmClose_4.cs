...
{
    public partial class frmClose_4 : Form
    {
        ...
        private void Close_Work_Real(cls_Connect_DB Temp_Connect , SqlConnection Conn, SqlTransaction tran)
        {
            ...
            StrSql = " EXEC Usp_Close4_Pro_251_A_Put_tbl_CloseTotal_Put1 '" + FromEndDate + "','" + ToEndDate + "','" + PayDate + "','" + cls_User.gid + "'";
            ...
            StrSql = " EXEC Usp_Close4_Pro_100_001 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();
         

            StrSql = " EXEC Usp_Close4_Pro_100_A_Sell_002 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();
         

            StrSql = " EXEC Usp_Close4_Pro_100_A_Sell_003 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();
         

            StrSql = " EXEC Usp_Close4_Pro_100_B_LevelCnt '" + FromEndDate + "','" + ToEndDate + "'"; 
            Temp_Connect.Insert_Data(StrSql, Conn, tran);            
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC Usp_Close4_Pro_100_B_ReqTF1 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            if (int.Parse(FromEndDate) >= Chang_Date_Close_Ver02)
                StrSql = " EXEC Usp_Close4_Pro_100_C_Put_Down_PV_01_Ver02 '" + FromEndDate + "','" + ToEndDate + "'";
            else
                StrSql = " EXEC Usp_Close4_Pro_100_C_Put_Down_PV_01 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC Usp_Close4_Pro_100_C_Put_Down_PV_01_BusCode '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            

            StrSql = " EXEC Usp_Close4_Pro_100_D_Put_Down_PV_01_Nom '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();


            //반품에 대해서 추가가됨 2019-12-12
            StrSql = " EXEC Usp_Close4_Pro_100_C_Put_Down_PV_Re_01 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);

            StrSql = " EXEC Usp_Close4_Pro_100_D_Put_Down_PV_Re_01_Nom '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            //반품에 대해서 추가가됨 2019-12-12
            ...
            StrSql = " EXEC Usp_Close4_Pro_100_B_ReqTF2 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC Usp_Close4_Pro_100_C_CurGrade_OrgGrade_Put '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();
            ...
            if (int.Parse(FromEndDate) >= Chang_Date_Close_Ver02)
                StrSql = " EXEC dbo.Usp_Close4_Pro_220_A_Give_OneGrade_Ver02 '" + FromEndDate + "','" + ToEndDate + "'";
            else
                StrSql = " EXEC dbo.Usp_Close4_Pro_220_A_Give_OneGrade '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
        ...
        Re_Grade_10:
            StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_10 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            if (Check_UP_Grade_TF(10, Temp_Connect, Conn, tran) == true) goto Re_Grade_10;            
            pg2.PerformStep(); pg2.Refresh();

        Re_Grade_20:
            StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_20 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            if (Check_UP_Grade_TF(20, Temp_Connect, Conn, tran) == true) goto Re_Grade_20;
            pg2.PerformStep(); pg2.Refresh();

        Re_Grade_30:
            StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_30 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            if(Check_UP_Grade_TF(30, Temp_Connect, Conn, tran) == true) goto Re_Grade_30;
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_40 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_50 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_60 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_70 '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            if (int.Parse(FromEndDate) >= Chang_Date_Close_Ver02)
            {
                StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_80_Ver02 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_90_Ver02 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_100_Ver02 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_110_Ver02 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_120_Ver02 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_130_Ver02 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_140_Ver02 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_150_Ver02 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();
            }
            else
            {
                StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_80 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_200_A_GiveGrade_90 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_100 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_110 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_120 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_130 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_140 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();

                StrSql = " EXEC dbo.Usp_Close4_Pro_210_A_GiveGrade_150 '" + FromEndDate + "','" + ToEndDate + "'";
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
                pg2.PerformStep(); pg2.Refresh();
            }
            ...
            if (int.Parse(FromEndDate) >= Chang_Date_Close_Ver02)
                StrSql = " EXEC Usp_Close4_Pro_230_A_Give_Allowance1_Ver02 '" + FromEndDate + "','" + ToEndDate + "'"; //직급달성 보너스 6
            else
                StrSql = " EXEC Usp_Close4_Pro_230_A_Give_Allowance1 '" + FromEndDate + "','" + ToEndDate + "'"; //직급달성 보너스 6
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC Usp_Close4_Pro_230_A_Give_Allowance3 '" + FromEndDate + "','" + ToEndDate + "'"; //직급달성 보너스 6
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC Usp_Close4_Pro_230_A_Give_Allowance5 '" + FromEndDate + "','" + ToEndDate + "'"; //직급달성 보너스 6
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC Usp_Close4_Pro_230_A_Give_Allowance6 '" + FromEndDate + "','" + ToEndDate + "'"; //직급달성 보너스 6
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            if (int.Parse(FromEndDate) >= Chang_Date_Close_Ver02)
            {
                StrSql = " EXEC Usp_Close4_Pro_230_A_Give_Allowance7_Ver02 '" + FromEndDate + "','" + ToEndDate + "'"; //직급달성 보너스 6
                Temp_Connect.Insert_Data(StrSql, Conn, tran);
            }
                //--------------------------------------------------------------
                ...
                StrSql = " EXEC Usp_Close4_Pro_235_A_Put_Sum_Return_Remain_Pay_Pre '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC Usp_Close4_Pro_240_A_Put_Sum_Return_Remain_Pay '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);            
            pg2.PerformStep(); pg2.Refresh();
            ////--------------------------------------------------------------
            ...
            //--------------------------------------------------------------
            if (int.Parse(FromEndDate) >= Chang_Date_Close_Ver02)
                StrSql = " EXEC Usp_Close4_Pro_240_B_CalculateTruePayment_Ver02 '" + FromEndDate + "','" + ToEndDate + "', 1 ";
            else
                StrSql = " EXEC Usp_Close4_Pro_240_B_CalculateTruePayment '" + FromEndDate + "','" + ToEndDate + "', 1 ";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);            
            pg2.PerformStep(); pg2.Refresh();

            

            StrSql = " EXEC Usp_Close4_Pro_240_C_Chang_RetunPay_Table '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);

            StrSql = " EXEC Usp_Close4_Pro_240_B_Chang_RetunPay_Table_DED '" + FromEndDate + "','" + ToEndDate + "'";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);
            pg2.PerformStep(); pg2.Refresh();
            //--------------------------------------------------------------
            //--------------------------------------------------------------
            ...
            StrSql = " EXEC Usp_Close4_Pro_251_B_Put_tbl_CloseTotal_Put2 '" + FromEndDate + "','" + ToEndDate + "' ";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);            
            pg2.PerformStep(); pg2.Refresh();


            StrSql = " EXEC Usp_Close4_Pro_251_C_Put_tbl_CloseTotal_Put3 '" + FromEndDate + "','" + ToEndDate + "' ";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);            
            pg2.PerformStep(); pg2.Refresh();
            //--------------------------------------------------------------
            ...
            //--------------------------------------------------------------
            if (int.Parse(FromEndDate) >= Chang_Date_Close_Ver02)
                StrSql = " EXEC Usp_Close4_Pro_260_A_MakeModForCheckRequirement1_Ver02 '" + FromEndDate + "','" + ToEndDate + "','" + PayDate + "' ";
            else
                StrSql = " EXEC Usp_Close4_Pro_260_A_MakeModForCheckRequirement1 '" + FromEndDate + "','" + ToEndDate + "','" + PayDate + "' ";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);            
            pg2.PerformStep(); pg2.Refresh();

            if (int.Parse(FromEndDate) >= Chang_Date_Close_Ver02)
                StrSql = " EXEC Usp_Close4_Pro_260_B_ReadyNewForCheckRequirement1_Ver02 '" + FromEndDate + "','" + ToEndDate + "','" + PayDate + "' ";
            else
                StrSql = " EXEC Usp_Close4_Pro_260_B_ReadyNewForCheckRequirement1 '" + FromEndDate + "','" + ToEndDate + "','" + PayDate + "' ";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);            
            pg2.PerformStep(); pg2.Refresh();

            StrSql = " EXEC Usp_Close4_Pro_270_Check_Close_Gid '" + FromEndDate + "','" + ToEndDate + "','" + cls_User.gid + "' ";
            Temp_Connect.Insert_Data(StrSql, Conn, tran);            
            pg2.PerformStep(); pg2.Refresh();
            //--------------------------------------------------------------
           ...
           // //Put_Down_SumPV_Mon_PR(Temp_Connect, Conn, tran);
           // //pg2.PerformStep(); pg2.Refresh();

           // Put_OrgGrade(Temp_Connect, Conn, tran);
           // pg2.PerformStep(); pg2.Refresh();

           // ////string StrSql = " Update tbl_CloseTotal_04 SET CurPoint = BePoint" ;
           // ////Temp_Connect.Insert_Data(StrSql, Conn, tran);
           ...
           // //Put_Down_SumPV(Temp_Connect, Conn, tran);  //본인 PV 하선의 기간의 OV  hig no hig  를 잡아준다'            
            
           // //Put_Self_PV(Temp_Connect, Conn, tran);        

           // if (FromEndDate == "20180702")
           //     Put_Down_PV_Be_M_01(Temp_Connect, Conn, tran);  //이전 내역이 없기 때문에 하나하나 계산한다.
           // else
           // {
           //     string StrSql = "Update tbl_ClosePay_04 SET ";
           //     StrSql = StrSql + "  Be_Down_PV_1 =  ISNULL(B.Cur_Down_PV_1,0)";
           //     StrSql = StrSql + " ,Be_Down_PV_2 =  ISNULL(B.Cur_Down_PV_2,0)";
           //     StrSql = StrSql + " FROM  tbl_ClosePay_04  A, ";

           //     StrSql = StrSql + " (";
           //     StrSql = StrSql + "Select   Cur_Down_PV_1 , Cur_Down_PV_2 ";
           //     StrSql = StrSql + " ,Mbid,Mbid2 "; 
           //     StrSql = StrSql + " From tbl_ClosePay_04_Mod ";
           //     StrSql = StrSql + " Where  ToEndDate in (Select Max(ToEndDate) From tbl_CloseTotal_04  (nolock)  )   ";                
           //     StrSql = StrSql + " ) B";
           ...
           // Put_Down_PV_01(Temp_Connect, Conn, tran);  //하선의 마감 기간의 매출을 하나하나 잡아준다.

           // //Put_Down_PV_02(Temp_Connect, Conn, tran);  //하나 하나 잡아준거를 합산한다. 후원수당 관련 해서.
           ...
           // //GiveGrade1(Temp_Connect, Conn, tran);            
           // //GiveGrade2(Temp_Connect, Conn, tran);
           // //GiveGrade3(Temp_Connect, Conn, tran); //Pro
           // //GiveGrade4(Temp_Connect, Conn, tran);  //Executive            
            
           // //string SDate3 = "";
           // //SDate3 = FromEndDate;
           // //while (int.Parse(SDate3) <= int.Parse(ToEndDate))
           // //{
           // //    Put_Down_SumPV_Day(Temp_Connect, Conn, tran, SDate3);
           // //    GiveGrade5_Day(Temp_Connect, Conn, tran, SDate3); //Elite
           // //    //GiveGrade5(Temp_Connect, Conn, tran);  //Elite                

           // //    DateTime dt = DateTime.Parse(SDate3.Substring(0, 4) + "-" + SDate3.Substring(4, 2) + "-" + SDate3.Substring(6, 2));
           // //    SDate3 = dt.AddDays(1).ToShortDateString().Replace("-", "");
           // //}
           // //GiveGrade6(Temp_Connect, Conn, tran);  //Bronze            
           // //GiveGrade7(Temp_Connect, Conn, tran); // Silver            
           // //GiveGrade8(Temp_Connect, Conn, tran); //Gold
           // //GiveGrade9(Temp_Connect, Conn, tran); //Platinum
           // //GiveGrade10(Temp_Connect, Conn, tran); //Ruby
           // //GiveGrade11(Temp_Connect, Conn, tran); //Emerald
           // //GiveGrade12(Temp_Connect, Conn, tran); //Diamond
           // //GiveGrade13(Temp_Connect, Conn, tran); //Crown
           // //GiveGrade14(Temp_Connect, Conn, tran); //로얄 Crown
           // ////--------------------------------------------------------------

           // //GradeUpLine2(20, Temp_Connect, Conn, tran);            
            
           // //Put_ReqTF2_OneGrade_R(Temp_Connect, Conn, tran);            
           // //Put_Grade_P(Temp_Connect, Conn, tran);
           // //Put_tbl_ClosePay_04_G(Temp_Connect, Conn, tran);
           ...
           // //Give_Allowance1(Temp_Connect, Conn, tran);  // 직급 보너스 공유 수당 1,2,3,4,5,6,7  //이전에 사용되는거

           // Put_ReqTF2_OneGrade(Temp_Connect, Conn, tran);            
           // Give_Allowance_3_4_5_2018_0702(Temp_Connect, Conn, tran);  // 직급 보너스 공유 수당 3,4,5   //현재까ㅓ
           // pg2.PerformStep(); pg2.Refresh();

           // //Give_Allowance2(Temp_Connect, Conn, tran);  //추천매칭 커미션  8
           // //pg2.PerformStep(); pg2.Refresh();

           // //Give_Allowance2_Be(Temp_Connect, Conn, tran);
           // //Give_Allowance2_TEST(Temp_Connect, Conn, tran);
           // //Give_Allowance7(Temp_Connect, Conn, tran);  //직급 보너스에 대한 세대 매칭
           // //Give_Allowance8(Temp_Connect, Conn, tran);   //주간 퀵스타트에 대한 세대 매칭
            

           // //Give_Allowance9(Temp_Connect, Conn, tran);   //센타비ㅣ AV의 5% 지급한다.   9                     
           // //pg2.PerformStep(); pg2.Refresh();
           // //--------------------------------------------------------------


           // //Give_Allowance11(Temp_Connect, Conn, tran);   //직급달성보너스
           // //Give_Allowance12(Temp_Connect, Conn, tran);   //직급달성보너스
           ...
           //// CalculateTruePayment_US(Temp_Connect, Conn, tran);            
           ...
           // Check_Close_Gid(Temp_Connect, Conn, tran,4,0);
           // pg2.PerformStep(); pg2.Refresh();
           // //--------------------------------------------------------------
     ...
     private void   Put_DayPV(cls_Connect_DB Temp_Connect, SqlConnection Conn, SqlTransaction tran)
        ...
        private void Put_Self_PV( cls_Connect_DB Temp_Connect, SqlConnection Conn, SqlTransaction tran )
       {
        ...
        private void Return_Close_Retry_DayC(ref int ReturnClose_FLAG)
        {
            ...
            Min_SellDate_2 = "";
            string StrSql = "Select isnull(MIN(SellDate_2),'') From CKDPHARM.dbo.tbl_SalesDetail (nolock)";
            StrSql = StrSql + " Where Ordernumber in ( Select  Re_BaseOrdernumber  From CKDPHARM.dbo.tbl_SalesDetail(nolock) ";            
            StrSql = StrSql + "                            Where  (ReturnTF = 2 Or ReturnTF = 3 )  ";
            StrSql = StrSql + "                         )";            
            StrSql = StrSql + " And   ReturnTF = 1  And   Ga_Order = 0 ";
            StrSql = StrSql + " And   Ordernumber not in (select Re_baseOrdernumber from CKDPHARM.dbo.tbl_SalesDetail (nolock) where Ordernumber in( Select Re_Ordernumber From CKDPHARM.dbo.tbl_ClosePay_04_Re_Ord (nolock)))"; // ''이미 마감 처리된 반품을 포함하지 마라.
            ...
            StrSql = StrSql + " From CKDPHARM.dbo.tbl_CloseTotal_04 (nolock)";
        ...
        private void Check_Return_Week(cls_Connect_DB Temp_Connect, SqlConnection Conn, SqlTransaction tran, ref string Min_ToEndDate, ref string  Min_FromEndDate )
        {
            ...
            StrSql = "Select isnull(MIN(SellDate_2),'') From CKDPHARM.dbo.tbl_SalesDetail (nolock)";
            StrSql = StrSql + " Where Ordernumber in ( Select  Re_BaseOrdernumber  From CKDPHARM.dbo.tbl_SalesDetail(nolock) ";
            StrSql = StrSql + "                            Where  (ReturnTF = 2 Or ReturnTF = 3 )  ";
            StrSql = StrSql + "                         )";
            StrSql = StrSql + " And   ReturnTF = 1  And   Ga_Order = 0 ";
            ...
            StrSql = "Select FromEndDate,ToEndDate  From CKDPHARM.dbo.tbl_CloseTotal_04 (nolock)";
        ...
        {
            string StrSql = "Select FromEndDate,ToEndDate ,PayDate From CKDPHARM.dbo.tbl_CloseTotal_04 (nolock)";
