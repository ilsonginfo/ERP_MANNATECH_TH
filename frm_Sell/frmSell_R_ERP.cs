...
{
    public partial class frmSell_R_ERP : clsForm_Extends
    {
       ...
       // Class.DevGridControlService cgb = new Class.DevGridControlService();
        ...
        private void Set_Sales_Cacu(string OrderNumber)
        {
            ...
            strSql = strSql + " LEFT JOIN tbl_Bank (nolock) ON Right(tbl_Sales_Cacu.C_Code,2)  = Right(tbl_Bank.Ncode,2)  And tbl_Sales_Cacu.C_TF  ";
