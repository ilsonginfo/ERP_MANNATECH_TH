...
{
    public partial class frmSell_Select_SellTF_Delete : clsForm_Extends
    {
        ...
        public frmSell_Select_SellTF_Delete()
        {
            InitializeComponent();
        }
        ...
        private void Make_Base_Query_(ref string Tsql)
        {
            ...
            string strSql = " Where tbl_SalesDetail.Ga_Order = 1  And tbl_SalesDetail.ReturnTF = 1 ";
            ...
            //가입일자로 검색 -1
            if ((txtRegDate1.Text.Trim() != "") && (txtRegDate2.Text.Trim() == ""))
                strSql = strSql + " And tbl_SalesDetail.SellDate = '" + txtRegDate1.Text.Trim() + "'";

            //가입일자로 검색 -2
            if ((txtRegDate1.Text.Trim() != "") && (txtRegDate2.Text.Trim() != ""))
            {
                strSql = strSql + " And tbl_SalesDetail.SellDate >= '" + txtRegDate1.Text.Trim() + "'";
                strSql = strSql + " And tbl_SalesDetail.SellDate <= '" + txtRegDate2.Text.Trim() + "'";
            }
            ...
            try
            {
                ...
                for (int i = 0; i < dGridView_Base.Rows.Count; i++)
                {
                    if (dGridView_Base.Rows[i].Cells[0].Value.ToString() == "V")
                    {
                        ...
                        StrSql = "EXEC Usp_Insert_tbl_Sales_CanCel_CS '" + OrderNumber + "','" + cls_User.gid + "',0";
        ...
        private void radioB_S_Base_Click(object sender, EventArgs e)
        {
            ...
            Data_Set_Form_TF = 1;
            cls_form_Meth ct = new cls_form_Meth();
            ct.Search_Date_TextBox_Put(txtRegDate1, txtRegDate2, (RadioButton)sender);
            Data_Set_Form_TF = 0;
        }
