...
namespace MLM_Program
{
    public partial class frmSell_Select_Card_App : clsForm_Extends
    {
        ...
        public frmSell_Select_Card_App()
        {
            InitializeComponent();
        }
        ...
        private void Make_Base_Query(ref string Tsql)
        {
            ...
            Tsql = Tsql + ", Case When C_Period1 <>'' And C_Period2 <> '' then   Right (C_Period1,2 ) + C_Period2 ELSE '' End ";
        ...
        {
            //카드 결제이고 카드 번호가 있고. 승인 번호와 ksnet 관련 인증 번호가 없다. 
            string strSql = " Where tbl_Sales_Cacu.C_TF = 3 And C_Number1 <> '' And C_Number2 = '' And C_Number3 = ''  ";
        ...
        private Boolean Chang_CenterCode()
        {
            ...
            string StrSql = "";
            string T_rStatus = "";
            string T_rAuthNo = "", C_Number3 = "", U_Name = "", CardNo = "", Card_Per = "", HalBu = "", T_Er_Msg = ""; 
            ...
            try
            {
                ...
                for (int i = 0; i < dGridView_Base.Rows.Count; i++)
                {
                    if (dGridView_Base.Rows[i].Cells[0].Value.ToString() == "V")
                    {
                        ...
                        C_Number3 = "";   // 거래번호      //저장해야함 승인취소시 사용됨.
                        T_Er_Msg = "";

                        //Usp_Insert_tbl_Sales_Cacu_Card.
                        ...
                        if (Seq_No > 0)
                        {
                            if (CardNo != "" && Card_Per != "" && Send_Amount > 0)
                               // C_Number3 = ksp.KSPayCreditPostMNI(OrderNumber, U_Name, "", "1", CardNo, Card_Per, HalBu, Send_Amount, T_currencytype, ref T_rStatus, ref T_rAuthNo, ref T_Er_Msg );
                            ...
                            if (C_Number3 != "" && T_rStatus != "X")
                            {
                                if (mtxtSellDate.Text.Replace("-", "").Trim() != "")
                                {
                                    ...
                                    StrSql = StrSql + " ,C_AppDate1 = '" + mtxtSellDate.Text.Replace("-", "").Trim() + "'";
