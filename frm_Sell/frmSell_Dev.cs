...
{
    public partial class frmSell_Dev : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void butt_Ord_Clear_Click(object sender, EventArgs e)
        {

        }

        private void labelControl92_Click(object sender, EventArgs e)
        {
        ...
        private void frmSell_Dev_Load(object sender, EventArgs e)
        {
            mtxtMbid.Focus();
            DoubleBuffered = true;
            SetStyle(ControlStyles.OptimizedDoubleBuffer, true);

            if (Environment.MachineName.Equals("MONSTER181108"))
              //  labelControl87.Visible = true;
                labelControl98.Visible = true;
           ...
           Save_Button_Click_Cnt = 0;
            ...
            if (cls_app_static_var.Sell_Union_Flag == "")
                labelControl27.Visible = false;  //조합이 아니면 공제 번호 관련 보여주지 않는다.
             //   labelControl28.Visible = false;
            Form_Key_Real_TF = 0;
            radioB_DESK.Checked = true;
            

            mtxtSellDate.Text= DateTime.Now.ToString("yyyy-MM-dd");
            mtxtSellDate2.Text = DateTime.Now.ToString("yyyy-MM-dd");
            mtxtPriceDate3.Text = DateTime.Now.ToString("yyyy-MM-dd");
            mtxtPriceDate1.Text = DateTime.Now.ToString("yyyy-MM-dd");
       ...
       //     mtxtPriceDate4.Mask = cls_app_static_var.Date_Number_Fromat;
           ...
           // txt_Price_4_2.BackColor = cls_app_static_var.txt_Enable_Color;
            ...
            txt_Price_5.BackColor = cls_app_static_var.txt_Enable_Color;
            txt_AV_C_AppDate1.BackColor = cls_app_static_var.txt_Enable_Color;
            txt_AV_C_Code.BackColor = cls_app_static_var.txt_Enable_Color;
            txt_AV_C_Number1.BackColor = cls_app_static_var.txt_Enable_Color;
            txt_Pass_Number.BackColor = cls_app_static_var.txt_Enable_Color;
            Data_Set_Form_TF = 1;
            ...
            txtCenter2_Code.Text = "001";
            txtCenter2.Text = "서울 비즈니스 센터";
            Data_Set_Form_TF = 0;
        ...
        private void Set_SalesDetail()
        {
            ...
            strSql = strSql + " Order By  SellDate DESC , OrderNumber DESC ";
        ...
        private void Set_gr_dic(ref Dictionary<int, object[]> gr_dic_text, string t_key, int fi_cnt)
        {
            object[] row0 = { SalesDetail[t_key].SellTFName
                                ...
                                ,SalesDetail[t_key].InputPassbook + SalesDetail[t_key].InputPassbook_2
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            if (cls_app_static_var.Sell_Union_Flag == "")  //직판특판이 아닌경우 공제번호 필드 안나오게
            {
                int[] g_Width = { 80, 0 , 120, 0, 0
                                  , 80  ,80 , 80 , 80 , 80
                                  , 80  ,80 ,80,80 ,cls_app_static_var.Using_Mileage_TF
                                  ,80 ,80 , 0
                                };
        ...
        private void dGridView_Base_Item_Header_Reset()
        {
            ...
            string[] g_HeaderText = {
                ""       , "상품_코드"   , "상품명"      , "개별단가"   , "개별PV"
              , "개별BV" , "주문_수량"   , "총상품액"    , "총상품PV"   , "총상품BV"
              , "구분"   , "_비고"
                                };

            string[] g_ColsName = {"Col1"  , "ItemCode"   , "ItemName"  , "ItemPrice"   , "ItemPV"
                                , "ItemBV" , "ItemCount"   , "ItemTotalPrice"    , "ItemTotalPV"  , "ItemTotalBV"
                                , "Gubun" , "Etc"
                                };
        ...
        private Boolean Check_Delete_TextBox_Error()
        {
            ...
            string Sql = string.Format("SELECT Union_Seq, InsuranceNumber FROM tbl_SalesDetail WHERE OrderNumber = '{0}'", txt_OrderNumber.Text);
            ...
            else if (bt.Name == "butt_Save")
            {
                ...
                if (Save_Error_Check > 0)
                {
                    ...
                    if (txt_OrderNumber.Text == "")
                    {
                        ...
                        //string Sql = "EXEC Usp_Insert_tbl_Sales_SMS '" + Temp_Ordernumber + "'";
                        //Temp_Connect.Insert_Data(Sql, "tbl_SalesDetail", this.Name, this.Text);
...
//            ct.from_control_clear(panel8, mtxtSellDate);
        ...
        private void Base_Sub_Save_Item()
        {
            ...
            //20190314구현호 이제 테이블반환함수를 바꿔서 새로 BV값을 넣어줘야한다.
        ...
        private void Base_Small_Item_Button_Click(object sender, EventArgs e)
        {
            ...
            else if (bt.Name == "butt_Item_Save")
            {
                ...
                if (txt_SalesItemIndex.Text == "") //추가 일경우에 새로운 입력
                {
                    ...
                    if (csd.Check_Stock_RealCnt(txt_ItemCode.Text.Trim(), int.Parse(txt_ItemCount.Text), ref Stock_cnt) == false)
                    {
        ...
        private void Base_Small_Rece_Button_Click(object sender, EventArgs e)
        {
            ...
            else if (bt.Name == "butt_Rec_Del")
            {
                ...
                //20190418구현호 배송주소 삭제시 출고된 내역이면 삭제를 막는다
            ...
            else if (bt.Name == "butt_Rec_Save")
            {
                ...
                {
                    //20190418구현호 배송주소 수정시 출고된 내역이면 수정을 막는다
                    if (dGridView_Base_Rece.Rows.Count == 1)
                    {
                        StringBuilder sb = new StringBuilder();
                        sb.AppendLine(" select * from tbl_StockOutput where OrderNumber = '" + txt_OrderNumber.Text.Trim() + "'");
                        ...
                        Temp_Connect.Open_Data_Set(sb.ToString(), "tbl_StockOutput", ds);
                        int ReCnt = Temp_Connect.DataSet_ReCount;
                        if (ReCnt != 0 && txt_OrderNumber.Text != "")
                        {
                            MessageBox.Show(cls_app_static_var.app_msg_rm.GetString("Msg_Sell_ChangeRece_In_Stockout")
                             + "\n" +
                              cls_app_static_var.app_msg_rm.GetString("Msg_Re_Action"));
                                             ...
                                             SqlConnection Conn, SqlTransaction tran, ref string T_ord_N)
        {
            ...
            else
            {
                ...
                string StrSql = "";
                StrSql = "INSERT INTO tbl_Sales_OrdNumber ";
                ...
                StrSql = StrSql + " Right('0000' + convert(varchar(6),convert(float,Right(Count(orderNumber),4)) + 1),4) ";
                ...
                StrSql = StrSql + " From tbl_Sales_OrdNumber  (nolock)  ";
                StrSql = StrSql + " Where LEFT(OrderNumber,8) = '" + mtxtSellDate.Text.Replace("-", "").Trim() + "'";

                if (Temp_Connect.Insert_Data(StrSql, "tbl_Sales_OrdNumber", Conn, tran, this.Name.ToString(), this.Text) == false) return;
                ...
                DataSet ds = new DataSet();
                //테이블에 맞게  DataSet에 내역을 넣고 제대로되었으면 true가 오고 아니면 걍 튀어나간다.
                if (Temp_Connect.Open_Data_Set(StrSql, "tbl_Sales_OrdNumber", ds) == false) return;
                int ReCnt = Temp_Connect.DataSet_ReCount;

                if (ReCnt == 0) return;

                SalesDetail[T_ord_N].OrderNumber = ds.Tables["tbl_Sales_OrdNumber"].Rows[0]["OrderNumber"].ToString();
                T_ord_N = ds.Tables["tbl_Sales_OrdNumber"].Rows[0]["OrderNumber"].ToString();
                //++++++++++++++++++++++++++++++++
            }
                                             ...
                                             SqlConnection Conn, SqlTransaction tran, string OrderNumber)
        {
            ...
            if (txt_OrderNumber.Text.Trim() == "")
            {
                ...
                StrSql = StrSql + " RecordID,RecordTime, Ga_Order ";
        ...
        private void Save_Base_Data(ref int Save_Error_Check)
        {
            ...
            //    foreach (int t_key in Sales_Rece.Keys)
            //    {
            //        if (Sales_Rece[t_key].Receive_Method == 1)
            //            Card_App_Cnt++;
            //    }

            //    if (Card_App_Cnt > 0)  //주문등록시 직접 수령이 잇는 경우에
            //    {
            //        if (MessageBox.Show("직접수령을 선택 하신 내역이 있습니다. 주문 센타 관련 정보가 올바릅니까?", "", MessageBoxButtons.YesNo) == DialogResult.No) return;
            //    }
            //}
            ...
            try
            {
                ...
                ////2018-09-29 김영수 팀장 10월 증정품 프로모션 추가함.
                //string StrSql = "EXEC Usp_Sales_Prom_4000 '" + Temp_Ordernumber + "'";
                //Temp_Connect.Delete_Data(StrSql, "tbl_Sales_Rece", Conn, tran, this.Name.ToString(), this.Text);

                //2018-11-29  지성경 프로모션 추가함.
                string StrSql = "EXEC Usp_Sales_Prom_81011 '" + Temp_Ordernumber + "'";
                Temp_Connect.Delete_Data(StrSql, "tbl_Sales_Rece", Conn, tran, this.Name.ToString(), this.Text);


                if (txt_OrderNumber.Text == "")  //새로운 저장일 경우에는 찾아서 직접 수령인 경우에만 넣는다.
                {

                    Save_Stock_OutPut_Data_(Temp_Connect, Conn, tran, New_Ordernumber);
        ...
        private void enable_Card_info_txt(Boolean TF_B)
        {
            ...
            labelControl66.Enabled = TF_B;
         //   labelControl67.Enabled = TF_B;
            labelControl68.Enabled = TF_B;
         //   labelControl69.Enabled = TF_B;
            labelControl70.Enabled = TF_B;
       //     labelControl71.Enabled = TF_B;
            labelControl72.Enabled = TF_B;
        //    labelControl73.Enabled = TF_B;
            labelControl74.Enabled = TF_B;
       //     labelControl75.Enabled = TF_B;
            labelControl76.Enabled = TF_B;
        //    labelControl77.Enabled = TF_B;
            labelControl78.Enabled = TF_B;
         //   labelControl79.Enabled = TF_B;
            //labelControl80.Enabled = TF_B;
            labelControl81.Enabled = TF_B;
        //    labelControl82.Enabled = TF_B;
            labelControl83.Enabled = TF_B;
        //    labelControl84.Enabled = TF_B;
            labelControl85.Enabled = TF_B;
       //     labelControl86.Enabled = TF_B;
        ...
        private void enable_Av_Bank_info_txt(Boolean TF_B)
        {
            ...
            labelControl130.Enabled = TF_B;
          //  labelControl133.Enabled = TF_B;
            labelControl142.Enabled = TF_B;
      //      labelControl143.Enabled = TF_B;
    ...
    private void Put_Sub_Date(string SalesItemIndex, string t_STF)
        {
            ...
            if (t_STF == "Cacu")
            {
                ...
                if (Sales_Cacu[C_index].C_TF == 1)
                {
                    ...
                    string price = Sales_Cacu[C_index].C_AppDate1.ToString();
                    mtxtPriceDate1.Text = Sales_Cacu[C_index].C_AppDate1.ToString();


                    //price = mtxtPriceDate1.DateToString(); //.Replace("-", "");
                ...
                if (Sales_Cacu[C_index].C_TF == 2)
                {
                    ...
                    mtxtPriceDate2.Text = Sales_Cacu[C_index].C_AppDate1.ToString();
                ...
                if (Sales_Cacu[C_index].C_TF == 3)
                {
                    ...
                    mtxtPriceDate3.Text = DateTime.Now.ToString("yyyy-MM-dd");
                    string price3 = Sales_Cacu[C_index].C_AppDate1.ToString();
                    mtxtPriceDate3.Text = Sales_Cacu[C_index].C_AppDate1.ToString();
        ...
        private void Set_SalesDetail(string OrderNumber)
        {
            ...
            {
                mtxtSellDate.Text = DateTime.Now.ToString("yyyy-MM-dd");
                string SellDate = SalesDetail[OrderNumber].SellDate.ToString();
                mtxtSellDate.Text = SalesDetail[OrderNumber].SellDate.ToString();


                mtxtSellDate2.Text = DateTime.Now.ToString("yyyy-MM-dd");

                string S_SellDate_2 = SalesDetail[OrderNumber].SellDate_2.Substring(0, 4) + '-' + SalesDetail[OrderNumber].SellDate_2.Substring(4, 2) + '-' + SalesDetail[OrderNumber].SellDate_2.Substring(6, 2);

                mtxtSellDate2.Text = S_SellDate_2.ToString();
        ...
        private void butt_Print_Click(object sender, EventArgs e)
        {
            ...
            if (Products.Rows.Count < 19)
            {
                for (int i = Products.Rows.Count; i < 19; i++)
                {
                    DataRow Product = Products.NewRow();
                    Products.Rows.Add(Product);
                }
            }
            else if (Products.Rows.Count / 19 > 0)
            {
                int n = ((Products.Rows.Count / 19) + 1) * 28;
        ...
        {
            //20190312구현호 1 카드승인시 돈다.
            if (Base_Error_Check__01() == false) return;  //주문종류 , 회원, 주문일자 입력 안햇는지 체크

            if (Item_Rece_Error_Check__01("Cacu", 1) == false) return;

            //20190312구현호 2 각종 카드승인관련 빈값체크
            if (txt_C_Card_Number.Text.Trim() == "")
            {
            ...
            //{
            //    MessageBox.Show("결제요청 금액이 결제해야할 금액보다 큽니다."
            //      + "\n" +
            //      cls_app_static_var.app_msg_rm.GetString("Msg_Re_Action"));
            //    txt_Price_3.Focus(); return;
            //}

            if (txt_C_P_Number.Visible == true)
            {
            ...
            string SuccessYN = "";
            string Err_M = "";
            //20190312구현호 3 카드결제관련 성공여부에 관련된 클래스, ordernumber = 주문번호, c_index = 0,Err_M = ""
            ...
            if (Save_Error_Check > 0)
            {
                string StrSql = "EXEC Usp_Sell_Cacu_ReCul '" + OrderNumber + "'";
                Temp_Connect.Update_Data(StrSql, "", "");


                if (txt_OrderNumber.Text == "")
                {
                    //2018-09-10 지성경 주문이 완료되면 이곳에 sms 보낼 수있도록 코딩해 줄 수 있다 ^ㅡ^
        ...
        private void buttonV_Ok_Click(object sender, EventArgs e)
        {
            ...
            cls_Connect_DB Temp_Connect = new cls_Connect_DB();
            //SuccessYN = Cls_Web.Dir_VR_VAccount_Approve_OK(OrderNumber, C_index, idx_Mbid2);

            //cls_Kicc_Send cks = new cls_Kicc_Send();
            //int ret =  cks.Cash_Card_Send_Singo_OK(OrderNumber, mtxtMbid.Text.Trim(), "Bank", C_index, "", "");

            frmBase_AV_Accnt_Danal e_f = new frmBase_AV_Accnt_Danal();
            e_f.Send_Accnt_Info += new frmBase_AV_Accnt_Danal.SendAccntDele(e_f_Send_Accnt_Info);
            e_f.Temp_OrderNumber = OrderNumber;
            e_f.Temp_C_Index = C_index;
            e_f.Call_AV_Accnt_Info += new frmBase_AV_Accnt_Danal.Call_AV_Accnt_Info_Dele(e_f_Call_Accnt_Info);
            e_f.ShowDialog();

            e_f.GetSuccessData(ref SuccessYN, ref SuccessMessage);
            if (Save_Error_Check > 0 && SuccessYN.Equals("Y"))
            {
                ...
                //cexig.CreateOrder(Temp_Ordernumber); //미국에 보낸다 엑시고를 통해서
                //cexig.CreatePayment(Temp_Ordernumber);
                //cexig.CreateCardPayment(Temp_Ordernumber);
                //cexig.ChangeOrderStatus(Temp_Ordernumber);
                ////---------------------------------------------------------
            ...
            if (FirstStart)
            {
                ////2018-07-11 지성경 주문 베리 땡큐!
                ////20190321 구현호 exec 수정
                //StrSql = string.Format("EXEC Usp_Insert_SMS '30', '{0}', {1}, '{2}', ''", "", mtxtMbid.Text, OrderNumber);
                //Temp_Connect.Update_Data(StrSql, "", "");
            }

            if (SuccessYN.Equals("Y"))
            {
                //2018-07-11 지성경 가상계좌관련 SMS 보낸다.
                StrSql = string.Format("EXEC Usp_Insert_SMS '20', '{0}', {1}, '{2}', '{3}'", "", mtxtMbid.Text, OrderNumber, VA_DEST_TEL.Trim());
                Temp_Connect.Update_Data(StrSql, "", "");
            }
            ...
            //cls_Web cccA = new cls_Web();
            //string VAResult = cccA.Dir_VR_Account_Approve_OK(OrderNumber, C_index, mtxtMbid.Text.Trim());
            //if (VAResult != "Y")
            //{
            ...
            //    //가상계좌관련 SMS 보낸다.
            //    new cls_sms().Here_Ur_VA(mtxtMbid.Text, OrderNumber);
            ...
            if (sender is TextBox)
            {
                ...
                if (tb.Name == "txt_Receive_Method")
                {
                    ...
                    if (tb.Text.Trim() == "직접수령")
                    {
                        ...
                        mtxtZip1.Enabled = false;
                        butt_AddCode.Enabled = false;
                    ...
                    else
                    {
                        ...
                        mtxtZip1.Enabled = true;
                        butt_AddCode.Enabled = true;
                    }
                }
        ...
        private void labelControl85_Click(object sender, EventArgs e)
        {
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            else if (Keys.Escape.Equals(keyData))
            {
        ...
        private void frmSell_Dev_KeyPress(object sender, KeyPressEventArgs e)
        {
