...
{
    public partial class frmStock_Select_Center : clsForm_Extends
    {
        ...
        {   
            ...
            if (cls_User.gid_CenterCode != "" && CenterCode == "")
                CenterCode = cls_User.gid_CenterCode;
            else
            {
                if (cls_User.gid_CenterCode != "" && CenterCode != "")
                {
                    if (cls_User.gid_CenterCode.Contains(CenterCode) == false )
                    {
                        CenterCode = "T191919";//아무코드나 넣어버린거임.
                    }
                }
            }
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = { "센타코드"   , "센타명" , "상품코드"   , "상품명"  , "총재고"      
                                ...
                                , "_총주문출고배송정보X", "총소진출고"  , "총이동출고"  , "총재고"  ,"전교환입고"
                                ,"교환입고"
                                    };
            cgb.grid_col_header_text = g_HeaderText;

            int[] g_Width = {  90, 120, 90, 130  ,90
                             ,100, 100, 100, 100, 100  
                             ,0 , 0, 0, 0, 100
                             ,100 , 100, 100 , 100 , 100
                             ,100 , 0 , 0 , 0 , 0
        ...
        private void dGridView_Sell_Item_Header_Reset()
        {
            ...
            string[] g_HeaderText = {"일자"  , "일반입고"   , "반품일반입고"  , "반품불량입고"   , "이동입고"        
                                , "주문출고"   , "주문출고직접"    , "주문출고배송"  , "주문출고센타" , "주문출고배송정보X"
                                , "소진출고"   , "이동출고"    , "재고량"  , "" , ""
                                };
