...
{
    public partial class frmStock_Select_Item_Day : clsForm_Extends
    {
        ...
        public frmStock_Select_Item_Day()
        {
            InitializeComponent();
        }
        ...
        private void Base_Button_Click(object sender, EventArgs e)
        {
            ...
            else if (bt.Name == "butt_Select")
            {
                ...
                Put_Stock_Detail(  txt_ItemName_Code2.Text.Trim(), txt_ItemName2.Text.Trim());   //뿌려주는 곳
        ...
        {
            Excel_Export_File_Name = this.Text; // "Stock_Item_In_Out_Select";
        ...
        private void Put_Stock_Detail ( string ItemCode, string ItemName)
        {   
            string strSql = "";
            double T_SumCnt = 0 ;
            ...
            strSql = "EXEC Usp_Stock_Sell_ALL_Day_Be_01 '" + ItemCode + "','" + SDAte1 + "'";
            ...
            strSql = "EXEC Usp_Stock_Sell_ALL_Day_Day_01 '" + ItemCode + "','" + ItemName + "','" + SDAte1 + "','" + SDate2 + "'"; 
