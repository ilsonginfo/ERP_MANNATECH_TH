...
{
    public partial class frmStock_Close_Center : clsForm_Extends
    {
        ...
        private Boolean Check_TextBox_Error()
        {
            ...
            if (txtCenter3_Code.Text == "")
            {
                MessageBox.Show("조회 센타 정보를 입력해 주십시요."
                        + "\n" +
        ...
        {   
            ...
            Tsql = "EXEC Usp_Stock_Close_Total_Na_02 '" + SDAte1 + "','" + SDate2 + "','" + CenterCode + "','" + cls_User.gid_CountryCode + "'," + SET_TF ;
