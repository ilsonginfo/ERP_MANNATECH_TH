...
namespace MLM_Program
{
    public partial class frmMileage_Select_Delete : clsForm_Extends
    {
        ...
        public frmMileage_Select_Delete()
        {
            InitializeComponent();
        ...
        private void dGridView_Base_Sub_Header_Reset()
        {
            ...
            string[] g_HeaderText = {"선택","회원번호",  "성명"  , "기록일"   , ""            
                                , "적립액", "사용액"  , ""   , "_코드"    , "구분"                                         
                                , "적립_주문번호" , "사용_주문번호"   ,  "기록자" , "비고" , "T_index"

                                };
            cg_Sub.grid_col_header_text = g_HeaderText;

            int[] g_Width = { 90,  110, 90, 100, 0                             
                             , 100 ,100 , 0 ,  0 , 100                               
                             , 100 ,100 , 100 ,  100 , 0                         
                            };
        ...
        private void chk_Total_MouseClick(object sender, MouseEventArgs e)
        {
            EventArgs ee = null;
            this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
            cg_Sub.basegrid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.ColumnHeader;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cg_Sub.basegrid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.ColumnHeader;
            for (int i = 0; i < dGridView_Base_Sub.Rows.Count; i++)
            {
                if (dGridView_Base_Sub.Rows[i].Selected == true)
                    dGridView_Base_Sub.Rows[i].Cells[0].Value = "V";
        ...
        private Boolean Chang_CenterCode()
        {
            ...
            try
            {
                ...
                progress.Maximum = dGridView_Base_Sub.Rows.Count + 1;
                for (int i = 0; i < dGridView_Base_Sub.Rows.Count; i++)
                {
                    if (dGridView_Base_Sub.Rows[i].Cells[0].Value.ToString() == "V")
                    {
                        T_index = int.Parse(dGridView_Base_Sub.Rows[i].Cells[13].Value.ToString());                        

                        StrSql = "Insert into tbl_Member_Mileage_Mod ";
                        ...
                        StrSql = "Delete  From tbl_Member_Mileage  ";
                        StrSql = StrSql + " Where T_index  =" + T_index ;
