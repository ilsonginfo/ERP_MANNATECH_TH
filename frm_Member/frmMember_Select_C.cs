...
{
    public partial class frmMember_Select_C : clsForm_Extends
    {
        ...
        private void Make_Base_Query(ref string Tsql)
        {
            ...
            Tsql = Tsql + " , Case  When tbl_Memberinfo.C_For_Kind_TF = 0 then '내국인' ELSE  '외국인' End"; 
        ...
        {
            string strSql = " Where tbl_Memberinfo.C_M_Name <> ''  ";
            ...
            if ((mtxtCDate1.Text.Replace("-", "").Trim() != "") && (mtxtCDate2.Text.Replace("-", "").Trim() == ""))
                strSql = strSql + " And Replace(Left(tbl_Memberinfo.Recordtime,10),'-','')  = '" + mtxtCDate1.Text.Replace("-", "").Trim() + "'";

            //변경일자로 검색 -2
            if ((mtxtCDate1.Text.Replace("-", "").Trim() != "") && (mtxtCDate2.Text.Replace("-", "").Trim() != ""))
            {
                strSql = strSql + " And Replace(Left(tbl_Memberinfo.Recordtime,10),'-','') >= '" + mtxtCDate1.Text.Replace("-", "").Trim() + "'";
                strSql = strSql + " And Replace(Left(tbl_Memberinfo.Recordtime,10),'-','') <= '" + mtxtCDate2.Text.Replace("-", "").Trim() + "'";
            }
            ...
            Tsql = Tsql + strSql ;
            Tsql = Tsql + " Order by  tbl_Memberinfo.Mbid2 ASC  ";
        }
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = {"부부사업자명"  , "부부사업주민번호"   , "부부사업자구분"  , "회원번호"   , "회원명"        
                                , "기록자"   , ""    , ""  , ""  
                                    };
        ...
        private void Set_gr_dic(ref DataSet ds, ref Dictionary<int, object[]> gr_dic_text, int fi_cnt)
        {
            ...
            object[] row0 = { ds.Tables[base_db_name].Rows[fi_cnt][0]
                                ,encrypter.Decrypt(ds.Tables[base_db_name].Rows[fi_cnt][1].ToString (),"Cpno")
