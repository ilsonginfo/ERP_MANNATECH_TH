...
{
    public partial class frmMember_Center_Change : clsForm_Extends
    {
       ...
       // private ContextMenu popUpMenu = new ContextMenu();
        ...
        public frmMember_Center_Change()
        {
            InitializeComponent();                                 
        }
        ...
        private void Make_Base_Query(ref string Tsql)
        {
            ...
            Tsql = Tsql + " , Case When tbl_Memberinfo.Ed_Date <> '' Then  LEFT(tbl_Memberinfo.Ed_Date,4) +'-' + LEFT(RIGHT(tbl_Memberinfo.Ed_Date,4),2) + '-' + RIGHT(tbl_Memberinfo.Ed_Date,2) ELSE '' End ";
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = {"선택" ,"회원_번호"  , "성명"   , "_주민번호"  , "_현직급"    
                                , "_위치"     , "센타명"   , "가입일"    , "집전화"   , "핸드폰"    
                                , "_교육일", "후원인"   , "후원인명"  , "추천인"   , "추천인명"   
                                ,"_우편_번호", "_주소"     , "_은행명"    , "_계좌번호" , "_예금주"     
                                , "구분", "활동_여부", "_중지_여부"  , "탈퇴일"  , "_라인중지일"  
                                ,"_기록자", "기록일", ""
                                    };
            cgb.grid_col_header_text = g_HeaderText;

            int[] g_Width = { 55 , 85, 90, 0, 0
                             , 0 ,100, 90, 130, 130
        ...
        private void Set_gr_dic(ref DataSet ds, ref Dictionary<int, object[]> gr_dic_text, int fi_cnt)
        {
            object[] row0 = { ds.Tables[base_db_name].Rows[fi_cnt][0]
                                ...
                                ,encrypter.Decrypt (ds.Tables[base_db_name].Rows[fi_cnt][9].ToString ())
