...
{
    public partial class frmMember_TreeGroup_Nom : clsForm_Extends
    {
        ...
        public frmMember_TreeGroup_Nom()
        {
            InitializeComponent();
        ...
        private void frmBase_Resize(object sender, EventArgs e)
        {
            ...
            butt_PreView.Width = base_w;
            butt_Excel.Width = base_w;
            butt_Exit.Width = base_w;

            butt_Clear.Left = 0;
            butt_Select.Left = butt_Clear.Left + butt_Clear.Width;
            butt_PreView.Left = butt_Select.Left + butt_Select.Width;
            butt_Excel.Left = butt_PreView.Left + butt_PreView.Width;
        ...
        private void Base_Button_Click(object sender, EventArgs e)
        {
            ...
            else if (bt.Name == "butt_Excel")   //이미지 저장
            {
                ...
                //pB_P.Image.Save("D:/DDDD.jpg");
                //printD.ShowDialog();
              //  BaseDoc.PrinterSettings.PrintToFile = true;
               // BaseDoc.PrinterSettings.PrintFileName = "backup.prn";
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (Tree_Mem_Get(Mbid, Mbid2, txtSellDate3.Text.Trim(), 1, combo_Se_Code.Text.Trim(), txtSellDate1.Text.Trim(), txtSellDate2.Text.Trim()) == true)             
            {
        ...
        public bool Tree_Mem_Get(string Mbid, int Mbid2, string SearchDate, int Line_User_V_TF, string SellCode, string SellDate1, string SellDate2)
        {
            if (TreeDic != null)
                TreeDic.Clear();
            if (LineDic != null)
            ...
            string G_SellCode = ""; string G_SellDate1 = ""; string G_SellDate2 = "";
            string Tsql;
            ...
            Tsql = "Exec Usp_Mem_Group_Nomin_TT '" + Mbid + "'," + Mbid2 + ",'" + SearchDate + "'," + Line_User_V_TF + ",'" + G_SellCode + "','" + G_SellDate1 + "','" + G_SellDate2 + "'";
            ...
            for (int fi_cnt = 0; fi_cnt <= ReCnt - 1; fi_cnt++)
            {
                ...
                if (int.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Leave"].ToString()) == -100)
                    t_Mem_Treel.LeaveCheck = cm._chang_base_caption_search("휴면");                     
        ...
        private void Group_Tree_Print_Pre_BP_Work()
        {
            ...
            while (PB_Print_H_Cur_PagCnt <= PB_H_Print_PagCnt)
            {
                ...
                while (PB_Print_W_Cur_PagCnt <= PB_W_Print_PagCnt)
                {
                    ...
                    string Image_Name = mtxtMbid.Text.Trim() + "_GroupTreeNom_" + PB_Print_H_Cur_PagCnt + "_" + PB_W_Print_PagCnt;
        ...
        private void tabC_1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                cls_Grid_Base_info_Put cgbp = new cls_Grid_Base_info_Put();
                cgbp.dGridView_Put_baseinfo(this, dGridView_Up_Sa, "saveup", Mouse_Select_key);
            }

            if (tabC_1.SelectedIndex == 6)
            {
                cls_Grid_Base_info_Put cgbp = new cls_Grid_Base_info_Put();
                cgbp.dGridView_Put_baseinfo(this, dGridView_Up_N, "nominup", Mouse_Select_key);
            }
        ...
        private void combo_Step_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            if (TreeDic == null)
                return;
            if (TreeDic.Count == 0)
