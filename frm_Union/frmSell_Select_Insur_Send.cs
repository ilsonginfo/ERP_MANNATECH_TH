...
{
    public partial class frmSell_Select_Insur_Send : clsForm_Extends
    {
        ...
        public frmSell_Select_Insur_Send()
        {
            InitializeComponent();
        }
        ...
        private void Make_Base_Query_(ref string Tsql)
        {
            ...
            string strSql = " Where tbl_SalesDetail.ReturnTF = 1  AND tbl_SalesDetail.Sellcode <> '' ";
            strSql = strSql + " And tbl_SalesDetail.InsuranceNumber = ''  And TotalPrice > 0  AND tbl_SalesDetail.Ga_Order = 0 ";
            
            //strSql = strSql + " And tbl_SalesDetail.InsuranceNumber = '' And TotalInputPrice - InputPass_Pay  <= TotalPrice  And TotalPrice > 0   ";
        ...
        private void Base_Grid_Set()
        {
            ...
            for (int fi_cnt = 0; fi_cnt <= ReCnt - 1; fi_cnt++)
            {
                ...
                SumTotalPrice += Convert.ToInt32( ds.Tables[base_db_name].Rows[fi_cnt]["TotalPrice"]);

            }


            txt_SumCnt.Text = string.Format(cls_app_static_var.str_Currency_Type, ReCnt);
            txt_P_1.Text = string.Format(cls_app_static_var.str_Currency_Type, SumTotalPrice);
        ...
        private Boolean Chang_CenterCode()
        {
            ...
            finally
            {
                ...
                {
                    MessageBox.Show("공제번호 요청 : " + Send_Cnt
                         + "\n" + "공제번호 발급 : " + Suc_Cnt
                        + "\n" + "공제번호 발급 실패 : " + Err_Cnt
                        + "\n" + "공제번호 이미발행 : " + Same_Cnt
                       + "\n" + "입니다.");
        ...
        private void Sell_Ac_insurancenumber(string T_ord_N, ref int Err_Cnt, ref int Suc_Cnt, ref int Same_Cnt, ref int Send_Cnt, ref int Stop_SW)
        {
            string Req = "";
