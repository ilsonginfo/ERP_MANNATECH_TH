...
{
    public partial class frmSell_Select_Insur_TXT : clsForm_Extends
    {
        ...
        public frmSell_Select_Insur_TXT()
        {
            InitializeComponent();
        }
        ...
        private void Make_Base_Query(ref string Tsql)
        {
            ...
            Tsql += Environment.NewLine + "        ELSE tbl_Memberinfo.Cpno END CPNO";
            ...
            Tsql = Tsql + " , '' ";
            Tsql = Tsql + " , '' ";
            Tsql = Tsql + " , Case  When tbl_Memberinfo.Sell_Mem_TF = 0 then 'BP' ELSE  'PC' End";
        ...
        private void Make_Base_Query_(ref string Tsql)
        {
            ...
            string strSql = "";// " Where tbl_SalesDetail.ReturnTF = 1  ";
            strSql = strSql + " Where tbl_SalesDetail.ReturnTF = 1   And tbl_SalesDetail.InsuranceNumber = '' And TotalInputPrice - InputPass_Pay  = TotalPrice   And TotalPrice > 0 "; ;  //And W_T_TF <> -100 ";
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = {"선택" ,"회원_번호"  , "성명"   , "_주민번호"  , "현직급"    
            ...
            try
            {
                ...
                for (int i = 0; i < dGridView_Base.Rows.Count; i++)
                {
                    if (dGridView_Base.Rows[i].Cells[0].Value.ToString() == "V")
                    {
                        ...
                        string Mbid = dGridView_Base.Rows[i].Cells[1].Value.ToString();
                        string M_Name = dGridView_Base.Rows[i].Cells[2].Value.ToString();
                        string Cpno = "";
                        if(dGridView_Base.Rows[i].Cells[3].Value.ToString().Replace("-", "").Length > 6)
                         Cpno = dGridView_Base.Rows[i].Cells[3].Value.ToString().Replace("-", "").Substring(0, 7) + "******";

                        SellDate = dGridView_Base.Rows[i].Cells[7].Value.ToString().Replace("-", "");
                        double SellPrice = double.Parse(dGridView_Base.Rows[i].Cells[11].Value.ToString());

                        string PrintDetail = M_Name + "," + Mbid + "," + Cpno + "," + OrderNumber + "," + SellPrice + "," + SellDate;

                        Send_dic_text[m_Cnt][change_C] = PrintDetail;
                        change_C++;
                        ...
                        if (change_C == 500)
                        {
                            ...
                            string txtfname = "";
                            if (m_Cnt == 0)
                                txtfname = SellDate + "수동신고" + ".txt";
                            else
                                txtfname = SellDate + "수동신고" + "_" + m_Cnt.ToString() + ".txt";
                        ...
                        //Sell_Ac_insurancenumber(OrderNumber, ref Err_Cnt, ref Suc_Cnt, ref Same_Cnt, ref Send_Cnt, ref Stop_SW );    
                ...
                string txtfname2 = "";
                if (m_Cnt == 0)
                    txtfname2 = SellDate + "수동신고" + ".txt";
                else
                    txtfname2 = SellDate + "수동신고" + "_" + m_Cnt.ToString() + ".txt";
