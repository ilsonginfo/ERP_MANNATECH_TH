...
namespace MLM_Program
{
    public partial class frmClose_4_Select_03 : Form
    {
        ...
        private void Make_Base_Query(ref string Tsql)
        {
            ...
            Tsql = "Select Case When tbl_Close_Not_Pay_04.Seq is not null And tbl_Close_Not_Pay_04.Check_FLAG = 'N' then 'V' ELSE  '' End ,  ";
            ...
            //Tsql = Tsql + " ,0 Fresh_1";
            //Tsql = Tsql + " ,0 Fresh_2 ";
            Tsql = Tsql + " ,0 Sum_PV_1,0 Sum_PV_2 ";

            Tsql = Tsql + " ,0 Re_Cur_PV_1";


            Tsql = Tsql + " ,0 Re_Cur_PV_2";
            Tsql = Tsql + " ,0 Re_Cur_QV_1";   //반품처리전 실 하선PV
            Tsql = Tsql + " ,0 Re_Cur_QV_2";   //반품처리전 실 하선PV
            Tsql = Tsql + " ,0";   //반품처리전 수당 적용PV
            Tsql = Tsql + " ,0";   //반품처리전 수당 적용PV
            ...
            Tsql = Tsql + " , '' ";// Case When ReqTF10 =  1 then  '본인구매'   When ReqTF10 =  2 then 'ADS' When ReqTF10 =  3 then '우대고객' ELSE '' End ";
            ...
            Tsql = Tsql + ", (Isnull( Allowance1_D,0) +Isnull(  Allowance2_D,0)  +Isnull(  Allowance3_D,0)  +Isnull(  Allowance4_D,0)  +Isnull(  Allowance5_D,0) +Isnull(  Allowance6_D,0)  ) SumAllAllowance_Cut ";
            Tsql = Tsql + ", Isnull(Cur_DedCut_Pay,0) Cur_DedCut_Pay ";
            Tsql = Tsql + " , (Allowance1 + Allowance2 + Allowance3 +Allowance4 + Allowance5 + Allowance6  + tbl_ClosePay_04_Mod.Etc_Pay ) Cur_SumAllowance  ";
            Tsql = Tsql + " , (Allowance1 + Allowance2 + Allowance3 +Allowance4 + Allowance5 + Allowance6   + tbl_ClosePay_04_Mod.Etc_Pay  - Isnull(tbl_ClosePay_04_Mod.Cur_DedCut_Pay_DED,0) - Cur_DedCut_Pay)     Cur_D_SumAllowance  ";
            Tsql = Tsql + " , tbl_ClosePay_04_Mod.SumAllAllowance_Be_Not_Sum   Be_SumAllowance  ";
            Tsql = Tsql + " ,  (Allowance1 + Allowance2 + Allowance3 +Allowance4 + Allowance5 + Allowance6  - Cur_DedCut_Pay) + tbl_ClosePay_04_Mod.SumAllAllowance_Be_Not_Sum  + tbl_ClosePay_04_Mod.Etc_Pay - Isnull(tbl_ClosePay_04_Mod.Cur_DedCut_Pay_DED,0)  SumAllAllowance";
            ...
            Tsql = Tsql + ", Case ";
            Tsql = Tsql + "  When tbl_Close_Not_Pay_04.Check_FLAG = 'N' then '회원별화면'";
            Tsql = Tsql + "  When tbl_Close_Not_Pay_04.Check_FLAG = 'M' then '직접입력'";
            Tsql = Tsql + "  ELSE ''";
            Tsql = Tsql + "  End ";
            ...
            Tsql = Tsql + " Left Join tbl_Close_Not_Pay_04 (nolock ) on tbl_ClosePay_04_Mod.mbid = tbl_Close_Not_Pay_04.mbid And tbl_ClosePay_04_Mod.mbid2 = tbl_Close_Not_Pay_04.mbid2 and tbl_ClosePay_04_Mod.ToEndDate = tbl_Close_Not_Pay_04.ToEndDate And tbl_Close_Not_Pay_04.Close_FLAG = 'W'  ";
        ...
        private void Make_Base_Query_(ref string Tsql)
        {
           ...
           if ((mtxtFromDate1.Text.Replace("-", "").Trim() != "") && (mtxtFromDate2.Text.Replace("-", "").Trim() == ""))
            ...
            {
                strSql = strSql + " And tbl_ClosePay_04_Mod.BeforeGrade <  tbl_ClosePay_04_Mod.CurGrade ";
                strSql = strSql + " And tbl_ClosePay_04_Mod.CurGrade >= 10  ";


                //if (combo_Grade2_Code.Text != "")
                //    strSql = strSql + " And tbl_ClosePay_04_Mod.CurGrade = " + combo_Grade2_Code.Text ;
                ...
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 20 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 20 ";
                    C_TF++;
                }

                if (checkB_30.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 30 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 30 ";
                    C_TF++;
                }

                if (checkB_40.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 40 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 40 ";
                    C_TF++;
                }

                if (checkB_50.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 50 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 50 ";
                    C_TF++;
                }

                if (checkB_60.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 60 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 60 ";
                    C_TF++;
                }

                if (checkB_70.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 70 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 70 ";
                    C_TF++;
                }

                if (checkB_80.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 80 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 80 ";
                    C_TF++;
                }

                if (checkB_90.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 90 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 90 ";
                    C_TF++;
                }

                if (checkB_100.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 100 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 100 ";
                    C_TF++;
                }

                if (checkB_110.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 110 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 110 ";
                    C_TF++;
                }

                if (checkB_120.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 120 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 120 ";
                    C_TF++;
                }
                ...
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 130 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 130 ";
                    C_TF++;
                }

                if (checkB_140.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 140 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 140 ";
                    C_TF++;
                }

                if (checkB_150.Checked == true)
                {
                    if (C_TF > 0) strSql = strSql + " OR tbl_ClosePay_04_Mod.CurGrade = 150 ";
                    if (C_TF == 0) strSql = strSql + " And (  tbl_ClosePay_04_Mod.CurGrade = 150 ";
                    C_TF++;
                }
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            //Tsql = Tsql + " ,N_Down_PV , N_Dir_Active_Cnt ";
            //Tsql = Tsql + " ,Dir_Cnt_G10, Dir_Cnt_G20 ";
            //Tsql = Tsql + " ,Dir_Cnt_G30 ";
            //Tsql = Tsql + " , Case When ReqTF2 =  1 then 'Y' ELSE '' End  ";


            string[] g_HeaderText = {"_선택","회원번호", "성명", "_마감주차","마감_시작일"  
                                  ,"마감_종료일" ,"지급_일자"    ,"지급구분"  , "총매출PV"  , "총매출BV"
                                , "총매출액"  ,   "전직급", "현직급"   , "유지직급"  ,"당월후원PV_좌"
                                ,"당월후원PV_좌_반품" ,"당월후원PV_우" ,"당월후원PV_우_반품"  , "당월추천PV", "당월추천PV_반품"
                                , "직추천액티브인원" , "직추당월1스타수" , "직추당월2스타수" ,"직추당월3스타수"  , "액티브여부" 

                                , "_이월1" , "_이월2" ,"_반품1",  "_반품2"  ,"_반품전합계1"
                                ,"_반품전합계2", "_반품전공제1","_반품전공제2",  "_직급_4주합산좌" ,"_직급_4주합산우"


                                ,"_유지여부"    , "_4주본인"   , "_4주ADS" , "_4주직추멤버" , "_Active구분"

                                , "기타보너스" ,"승급보너스골드이하"   , "승급보너스1차" , "승급보너스2차"     , "성취보너스"    
                                , "액티브보너스"   , "센터보너스" , "_추천보너스"     , "_리더십보너스"    , "_PB보너스"     
                                , "_37프로모션"   , "_SCP"      , "_패키지보너스"    , "마감미지급액"   , "전_마감미지급액" 
                                  , "기타공제" ,  "Cap공제"     , "반품공제액"  ,"발생_당월수당합" ,"차감된_반품공제_기타공제포함합"
            ...
            string[] g_Cols = {"_선택","회원번호", "성명", "_마감주차","마감_시작일"
                                  ,"마감_종료일" ,"지급_일자"    ,"지급구분"  , "총매출PV"  , "총매출BV"
                                ...
                                , "액티브보너스"   , "센터보너스" , "_추천보너스"     , "_리더십보너스"    , "_PB보너스"
                                , "_37프로모션"   , "_SCP"      , "_패키지보너스"    , "마감미지급액"   , "전_마감미지급액"
                                  , "기타공제" ,  "Cap공제"    , "차감된_반품_공제액"  ,"발생_당월수당합" ,"차감된_반품공제_기타공제포함합"
        ...
        private void put_Sum_Dataview(DataSet ds, int ReCnt)
        {
            ...
            for (int fi_cnt = 0; fi_cnt <= ReCnt - 1; fi_cnt++)
            {
                ...
                Sum_dic["승급보너스골드이하"] = Sum_dic["승급보너스골드이하"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance1"].ToString());
                Sum_dic["승급보너스1차"] = Sum_dic["승급보너스1차"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance2"].ToString());
                Sum_dic["승급보너스2차"] = Sum_dic["승급보너스2차"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance3"].ToString());
                Sum_dic["성취보너스"] = Sum_dic["성취보너스"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance4"].ToString());
                Sum_dic["액티브보너스"] = Sum_dic["액티브보너스"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance5"].ToString());
                Sum_dic["센터보너스"] = Sum_dic["센터보너스"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance6"].ToString());

                //Sum_dic["프로모션"] = Sum_dic["프로모션"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance12"].ToString());
        ...
        private void Allowance_Detail(string T_Mbid, string ToEndDate)
        {
            ...
            cls_Grid_Base cgb_P1 = new cls_Grid_Base();
            dGridView_Base_Header_Reset(dGridView_Pay_1, cgb_P1, 22); //디비그리드 헤더와 기본 셋팅을 한다.
            cgb_P1.d_Grid_view_Header_Reset();
            Real_Allowance_Detail(ToEndDate, Mbid, Mbid2, "6", cgb_P1);  //직급수당

            dGridView_Base_Header_Reset(dGridView_Pay_2, cgb_P1, 1); //디비그리드 헤더와 기본 셋팅을 한다.
            cgb_P1.d_Grid_view_Header_Reset();
            //Real_Allowance_Detail(ToEndDate, Mbid, Mbid2, "9", cgb_P1);  //세대매칭보너스
            ...
            dGridView_Base_Header_Reset(dGridView_Pay_4, cgb_P1, 3); //디비그리드 헤더와 기본 셋팅을 한다.
            cgb_P1.d_Grid_view_Header_Reset();
            Real_Allowance_Detail_Up(ToEndDate, Mbid, Mbid2, cgb_P1);  //판매내역 역추적


            dGridView_Base_Header_Reset(dGridView_Pay_G, cgb_P1, 11); //디비그리드 헤더와 기본 셋팅을 한다.
            cgb_P1.d_Grid_view_Header_Reset();
            //Real_Allowance_Detail_G(ToEndDate, Mbid, Mbid2, 1, cgb_P1);  //기간직추액티브인원
            Real_Allowance_Detail_Nom(ToEndDate, Mbid, Mbid2, 3, cgb_P1);  //기간직추액티브인원
        }
        ...
        private void Real_Allowance_Detail(string ToEndDate, string Mbid, int Mbid2, string SortOrder, cls_Grid_Base cgb_P)
        {
            ...
            StrSql = StrSql + ",RequestName,DownPV,LineCnt, LevelCnt,OrderNumber,GivePay , SortOrder  ";
        ...
        private void Real_Allowance_Detail(string ToEndDate, string Mbid, int Mbid2, int SortOrder, cls_Grid_Base cgb_P)
        {
            ...
            StrSql = StrSql + ",RequestName, Sell_DownPV AS DownPV , Case When  LineCnt =  1 then '좌' ELSE '우' End LineCnt , LevelCnt ,Ordernumber";
        ...
        private void dGridView_Base_Header_Reset(DataGridView dGridView, cls_Grid_Base cgb_P, int S_TF = 0)
        {
            ...
            {
                string[] g_HeaderText = {"회원번호", "성명", "PV"  ,"대수"  ,""  
                                , "주문번호"     , ""  , ""   , ""    , ""                                   
                                    };
                cgb_P.grid_col_header_text = g_HeaderText;
            }
            ...
            try
            {
                ...
                for (int i = 0; i < dGridView_Base.DataRowCount; i++)
                {
                    if (dGridView_Base.GetRowCellValue(i, dGridView_Base.Columns[0]).ToString() == "V")
                    {
                        ...
                        if (Mbid2 > 0 || Mbid != "")
                        {
                            StrSql = "INSERT INTO tbl_Close_Not_Pay_04_04 ";
        ...
        private void dGridView_Base_DoubleClick_2(object sender, EventArgs e)
        {
            ...
            if (info.InDataRow && info.Column != view.Columns["선택"])
            {
                ...
                ToEndDate = view.GetRowCellValue(info.RowHandle, view.Columns[5]).ToString();
                FromEndDate = view.GetRowCellValue(info.RowHandle, view.Columns[4]).ToString();
        ...
        {
            Excel_Export_File_Name = "추천기간하선판매";
            Excel_Export_From_Name = this.Name;
