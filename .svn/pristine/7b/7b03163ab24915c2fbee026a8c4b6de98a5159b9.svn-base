...
{
    public partial class frmBase_Goods_Nation : Form
    {
        ...
        private void Base_Grid_Set(string Ncode = "")
        {
            ...
            Tsql = Tsql + " , Isnull (( Select Top 1 tbl_Goods_Change.price2 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods_Na_item.ItemCode And tbl_Goods_Change.Na_Code  = tbl_Goods_Na_item.Na_code Order by ApplyDate DESC   ),tbl_Goods_Na_item.price2) Last_price2 ";
            Tsql = Tsql + " , Isnull (( Select Top 1 tbl_Goods_Change.price4 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods_Na_item.ItemCode And tbl_Goods_Change.Na_Code  = tbl_Goods_Na_item.Na_code Order by ApplyDate DESC   ),tbl_Goods_Na_item.price4) Last_price4 ";
            Tsql = Tsql + " , Isnull (( Select Top 1 tbl_Goods_Change.price5 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods_Na_item.ItemCode And tbl_Goods_Change.Na_Code  = tbl_Goods_Na_item.Na_code Order by ApplyDate DESC   ),tbl_Goods_Na_item.price5) Last_price5 ";
        ...
        private bool Check_TextBox_Error(string SaveCheck_2, ref int Chang_Price_TF)
        {
            ...
            else
            {
                ...
                Tsql = Tsql + " , Isnull (( Select Top 1 price1 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods.Ncode And Na_Code ='" + combo_Se_Code.Text.Trim() + "' Order by ApplyDate DESC   ),price) Last_price ";
                Tsql = Tsql + " , Isnull (( Select Top 1 price2 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods.Ncode And Na_Code ='" + combo_Se_Code.Text.Trim() + "' Order by ApplyDate DESC   ),price2) Last_price2 ";
                Tsql = Tsql + " , Isnull (( Select Top 1 price3 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods.Ncode And Na_Code ='" + combo_Se_Code.Text.Trim() + "' Order by ApplyDate DESC   ),price4) Last_price3 ";
                Tsql = Tsql + " , Isnull (( Select Top 1 price4 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods.Ncode And Na_Code ='" + combo_Se_Code.Text.Trim() + "' Order by ApplyDate DESC   ),price4) Last_price4 ";
                Tsql = Tsql + " , Isnull (( Select Top 1 price5 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods.Ncode And Na_Code ='" + combo_Se_Code.Text.Trim() + "' Order by ApplyDate DESC   ),price5) Last_price5 ";
                Tsql = Tsql + " , Isnull (( Select Top 1 price6 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods.Ncode And Na_Code ='" + combo_Se_Code.Text.Trim() + "' Order by ApplyDate DESC   ),price6) Last_price6 ";
                Tsql = Tsql + " , Isnull (( Select Top 1 Except_Sell_VAT_Price From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods.Ncode And Na_Code ='" + combo_Se_Code.Text.Trim() + "' Order by ApplyDate DESC   ),Except_Sell_VAT_Price) Last_Except_Sell_VAT_Price ";
                Tsql = Tsql + " , Isnull (( Select Top 1 Sell_VAT_Price From tbl_Goods_Change Where tbl_Goods_Change.Ncode = tbl_Goods.Ncode And Na_Code ='" + combo_Se_Code.Text.Trim() + "' Order by ApplyDate DESC   ),Sell_VAT_Price) Last_Sell_VAT_Price ";
