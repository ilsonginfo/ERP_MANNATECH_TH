...
namespace MLM_Program
{
    public partial class frmBase_Goods_Set : Form
    {
        ...
        private void Base_Grid_Set(string Ncode = "")
        {
            ...
            Tsql = Tsql + " , Isnull (( Select Top 1 price2 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = B.Ncode  And Na_code = '' Order by ApplyDate DESC   ),B.Price2) Last_price2 ";
            Tsql = Tsql + " , Isnull (( Select Top 1 price4 From tbl_Goods_Change Where tbl_Goods_Change.Ncode = B.Ncode  And Na_code = '' Order by ApplyDate DESC   ),B.Price4) Last_price4 ";
            //, B.Price2 , B.Price4 " ;
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = { "Set상품코드" , "Set상품명" ,"회원가" , "PV"   , "포함상품코드"  
                                     , "포함상품명"   , "수량" 
                                    };
