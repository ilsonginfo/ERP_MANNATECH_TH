...
namespace MLM_Program
{
    public partial class frmBase_Member_Search : Form
    {
        ...
        private void Base_Grid_Set()
        {
            ...
            {
                Tsql = Tsql + " Where tbl_Memberinfo.M_name like '%" + txtMemberName.Text.Trim() + "%' ";
                Tsql = Tsql + " And   tbl_Memberinfo.Cpno = '" + encrypter.Encrypt(  txtCpno.Text.Trim()) + "' ";
            }
            ...
            if ((Search_Member_Number_Mbid != "") && (Search_Member_Number_Mbid2 == 0))
                Tsql = Tsql + " Where tbl_Memberinfo.Mbid like '%" + Search_Member_Number_Mbid + "%' ";

            if ((Search_Member_Number_Mbid == "") && (Search_Member_Number_Mbid2 != 0))
                Tsql = Tsql + " Where Convert(Varchar,tbl_Memberinfo.Mbid2) like '%" + Search_Member_Number_Mbid2.ToString () + "%' ";

            if ((Search_Member_Number_Mbid != "") && (Search_Member_Number_Mbid2 != 0))
            {
                Tsql = Tsql + " Where tbl_Memberinfo.Mbid like '%" + Search_Member_Number_Mbid + "%' ";
                Tsql = Tsql + " And   Convert(Varchar,tbl_Memberinfo.Mbid2) like '%" + Search_Member_Number_Mbid2.ToString() + "%' ";
            }
