...
namespace MLM_Program
{
    public partial class frmClose_4_Select_01 : Form
    {
        ...
        private void Make_Base_Query(ref string Tsql)
        {
            ...
            Tsql = Tsql + " , Allowance7,   Allowance9,Allowance13,Isnull(Allowance28,0)  Allowance28 ,Isnull(Allowance29,0)  Allowance29, SumAllowance , SumInComeTax  ";
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = {"웹적용여부","_마감주차","마감_시작일"  ,"마감_종료일"  ,"지급_일자"
                               , "기간판매액"       , "기간판매PV" , "기간반품액"     , "기간반품PV"    , "기간판매BV"
                               , "기간반품BV"    , "_PC_기간판매CV"  , "_PC_기간반품CV", "승급보너스골드이하"  ,"승급보너스1차"
                               , "승급보너스2차"  , "성취보너스"  , "액티브보너스"   , "센타보너스"  , "기타보너스"
                                 , "프로모션"     , "_PB"  ,"_37프로모션" ,"기타공제" , "반품공제액"
                               ...
                               , "매출_판매액"  , "매출_판매PV"  , "매출_판매BV" ,"매출_반품액"    ,"매출_반품PV"
                               ,"매출_반품BV"  ,"매출지급율_BV"
        ...
        private void put_Sum_Dataview(DataSet ds, int ReCnt)
        {
            ...
            cls_form_Meth cm = new cls_form_Meth();
             ...
             //, "직급수당_팀매니져"  ,"리더쉽 폴-P"    
             //                    , "리더쉽 폴-R"  , "리더쉽 폴-E"  , "리더쉽 폴-D", "리더쉽 폴-C"   , "세대매칭보너스-직급"  
             //                   , "세대매칭보너스-퀵스타트"   , "엘리트보너스"   , "" , ""     , ""    
            
            //Sum_dic["추천보너스"] = 0;
            //Sum_dic["직급수당_팀매니져"] = 0;
            //Sum_dic["직급수당_그룹매니져"] = 0;
            Sum_dic["승급보너스골드이하"] = 0;
            Sum_dic["승급보너스1차"] = 0;
            Sum_dic["승급보너스2차"] = 0;
            Sum_dic["성취보너스"] = 0;
            ...
            for (int fi_cnt = 0; fi_cnt <= ReCnt - 1; fi_cnt++)
            {
                //Sum_dic["직급수당_팀매니져"] = Sum_dic["직급수당_팀매니져"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance1"].ToString());
                //Sum_dic["직급수당_그룹매니져"] = Sum_dic["직급수당_그룹매니져"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance2"].ToString());
                ...
                //Sum_dic["직급프로모션"] = Sum_dic["직급프로모션"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance10"].ToString());
                // Sum_dic["직급달성보너스"] = Sum_dic["직급달성보너스"] + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Allowance11"].ToString());
