...
namespace MLM_Program
{
    public partial class frmClose_Sham_Pay : Form
    {
        ...
        private void Base_Sub_Grid_Set()
        {
            ...
            Tsql = Tsql + " , Case  ";
            Tsql = Tsql + "  When tbl_Sham_Pay.SortKind2  = 'W' then '주간' ";
            Tsql = Tsql + "  When tbl_Sham_Pay.SortKind2  = 'M' then '월간' ";
            //Tsql = Tsql + "  When tbl_Sham_Pay.SortKind2  = '2' then '매칭' ";
            //Tsql = Tsql + "  When tbl_Sham_Pay.SortKind2  = '3' then '멤버' ";
            //Tsql = Tsql + "  When tbl_Sham_Pay.SortKind2  = '4' then '승급' ";
            //Tsql = Tsql + "  When tbl_Sham_Pay.SortKind2  = '6' then '소비전환' ";
            ...
            string strSql = " Where   tbl_Sham_Pay.SortKind2 IN ('', 'M','W') "; 
            ...
            if ((mtxtMakeDate1.Text.Replace("-", "").Trim() != "") && (mtxtMakeDate2.Text.Replace("-", "").Trim() != ""))
            {
             ...
             if (radioB_S_Week.Checked == true )
                strSql = strSql + " And tbl_Sham_Pay.SortKind2 = 'W'";

            if (radioB_S_Month.Checked == true)
                strSql = strSql + " And tbl_Sham_Pay.SortKind2 = 'M'";



            //if (radioB_S_Pay.Checked == true)
            //    strSql = strSql + " And tbl_Sham_Pay.SortKind3 = 0";

            //if (radioB_S_Ded.Checked == true)
            //    strSql = strSql + " And tbl_Sham_Pay.SortKind3 = 1";
        ...
        private void Save_Base_Data(ref int Save_Error_Check)
        {
            ...
            if (radioB_ETC.Checked == true) SortKind2 = "W";
            if (radioB_Save.Checked == true) SortKind2 = "M"; 
        ...
        private void dGridView_Base_Sub_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (((sender as DataGridView).CurrentRow != null) && ((sender as DataGridView).CurrentRow.Cells[1].Value != null))
            {
                ...
                if (T_SortKind2 == "W") radioB_ETC.Checked = true;
                if (T_SortKind2 == "M") radioB_Save.Checked = true;
                ...
                //마감정산이 이루어진 판매 날짜인지 체크한다.                
                cls_Search_DB csd = new cls_Search_DB();
                if (T_SortKind2 == "W" && csd.Close_Check_SellDate("tbl_CloseTotal_02", mtxtSellDate.Text.Replace("-", "").Trim()) == false)
                {
                ...
                if (T_SortKind2 == "M" && csd.Close_Check_SellDate("tbl_CloseTotal_04", mtxtSellDate.Text.Replace("-", "").Trim()) == false)
                {
                    mtxtSellDate.ReadOnly = true;
                    mtxtSellDate.BorderStyle = BorderStyle.FixedSingle;
                    mtxtSellDate.BackColor = cls_app_static_var.txt_Enable_Color;
