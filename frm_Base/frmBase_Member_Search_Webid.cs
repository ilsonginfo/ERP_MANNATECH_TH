...
{
    public partial class frmBase_Member_Search_Webid : clsForm_Extends
    {
        ...
        public frmBase_Member_Search_Webid()
        {
            InitializeComponent();
        }
        ...
        private void Base_Grid_Set()
        {
            ...
            {
                sb.AppendLine(" And tbl_Memberinfo.Webid like '%" + txtMemberName.Text.Trim() + "%' ");
