...
namespace MLM_Program
{
    public partial class frmBase_Goods_Sort : Form
    {
        ...
        private void frmBase_From_Load(object sender, EventArgs e)
        {
            ...
            txtData.MaxLength = cls_app_static_var.Item_Sort_1_Code_Length;
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = { "대분류_코드" , "대분류명"   , ""  ,""   , ""                                       
                                    };
        ...
        {
            Excel_Export_File_Name = this.Text; // "Goods_Sort_1";
        ...
        private void Save_Base_Data(ref int Save_Error_Check)
        {
            ...
            if (ReCnt == 0)//동일한 은행 코드가없네 그럼 인설트
            {
                ...
                Tsql = "Insert Into tbl_MakeItemCode1 (ItemCode , ItemName, recordid, recordTime ) " ;
                Tsql = Tsql + " Values ( ";
            ...
            else //동일한 은행 코드가 있구나 그럼 업데이트
            {
                ...
                Tsql = "Update tbl_MakeItemCode1 Set ";
        ...
        private void Delete_Base_Data(ref int Del_Error_Check)
        {
            ...
            string Tsql;
            Tsql = "Delete From tbl_MakeItemCode1 ";
            Tsql = Tsql + " Where ItemCode = '" + txtData.Text.Trim() + "'";
        ...
        private Boolean Check_TextBox_Error(int i)
        {
            ...
            Tsql = Tsql + " Where LEFT(Ncode," + txtData.MaxLength + ") = '" + txtData.Text.Trim() + "'";
            ...
            //중분류에서 본인 코드를 사용했는지를 체크하다.
            Tsql = "Select UpitemCode ";
            Tsql = Tsql + " From tbl_MakeItemCode2 (nolock) ";
            Tsql = Tsql + " Where UpitemCode = '" + txtData.Text.Trim() + "'";
            Tsql = Tsql + " Order by UpitemCode ASC ";
            ...
            {
                MessageBox.Show(cls_app_static_var.app_msg_rm.GetString("Msg_Useing_Data")
                    + " - " + cls_app_static_var.app_msg_rm.GetString("Msg_Sort_Goods_Sort_2")
                    + "\n" +
                    cls_app_static_var.app_msg_rm.GetString("Msg_Re_Action"));
                txtData.Focus(); return false;
            }
        ...
        private void Form_Refresh_Data(string ncode)
        {
            ...
            Tsql = "Select ItemCode  ";
            Tsql = Tsql + " , ItemName  ";
            Tsql = Tsql + " From tbl_MakeItemCode1 (nolock) ";
            Tsql = Tsql + " Where ItemCode = '" + ncode + "'";
