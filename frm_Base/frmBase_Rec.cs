...
namespace MLM_Program
{
    public partial class frmBase_Rec : Form
    {
        ...
        private const string base_db_name = "tbl_Base_Rec";
    ...
    //string[] g_HeaderText = { "매입처 코드" , "매입처명" ,"" , ""   , "우편 번호"  
    ...
    //                , "대표자" , "업태" ,"종목" , "비고"
            ...
            Tsql = Tsql + " ,item ";
            Tsql = Tsql + " ,tbl_Base_Rec.Remarks ";
            Tsql = Tsql + ", Isnull(nationNameEng,'') nationNameEng , tbl_Base_Rec.Na_code ";

            Tsql = Tsql + " From tbl_Base_Rec (nolock) ";
            Tsql = Tsql + " LEFT JOIN  tbl_Nation  (nolock) ON tbl_Nation.nationCode = tbl_Base_Rec.Na_Code  ";
            Tsql = Tsql + " Where tbl_Base_Rec.Na_Code in (Select Na_Code From ufn_User_In_Na_Code('" + cls_User.gid_CountryCode + "') )";
            //if (tab_Nation.Visible == true)
            //{
            //    if (combo_Se_Code.Text != "")
            //    {
            //        Tsql = Tsql + " Where tbl_Base_Rec.Na_Code = '" + combo_Se_Code.Text + "'";
            //    }
            //}
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = { "배송사_코드" , "배송사명" ,"사용_여부" , ""   , "우편_번호"  
        ...
        {            
            if ((sender as DataGridView).CurrentRow.Cells[0].Value != null)
            {
                ...
                //T_string = T_Gd.CurrentRow.Cells[4].Value.ToString();
        ...
        private void Base_Button_Click(object sender, EventArgs e)
        {
            ...
            {
                //cls_app_static_var.Excel_Export_File_Name = this.Text; // "DeliveryCompany";
                //cls_app_static_var.Excel_Export_From_Name = this.Name;
                //cls_app_static_var._Excel_Grid = dGridView_Base;
        ...
        {
            Excel_Export_File_Name = this.Text; // "DeliveryCompany";
        ...
        private Boolean Check_TextBox_Error(int i)
        {
            ...
            Tsql = "select Base_Rec "; 
            Tsql = Tsql + " From tbl_Sales_Rece (nolock) ";
            Tsql = Tsql + " LEFT JOIN tbl_SalesDetail (nolock) ON tbl_Sales_Rece.OrderNumber = tbl_SalesDetail.OrderNumber ";
            Tsql = Tsql + " Where Base_Rec ='" + txtNcode.Text.Trim() + "'";
