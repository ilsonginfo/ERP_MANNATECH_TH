...
{
    public partial class frmBase_Nation : clsForm_Extends
    {

        cls_Grid_Base cgb = new cls_Grid_Base();
        private const string base_db_name = "tbl_Nation";

        public frmBase_Nation()
        {
            InitializeComponent();
        }
        ...
        private void frmBase_Nation_Load(object sender, EventArgs e)
        {
        ...
        private void Base_Grid_Set()
        {
            ...
            string Tsql;
            Tsql = "Select nationCode, nationNameKo, nationNameEng ";
            Tsql = Tsql + ", Case When Using_TF = 1 Then '사용' ELSE '' End   ";
            Tsql = Tsql + ", Using_TF  ";
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = { "국가_코드" , "국가명"   , "영문_국가명"  ,"사용_여부"   , "_Using_TF"                                       
                                    };
            cgb.grid_col_header_text = g_HeaderText;

            int[] g_Width = { 100, 150, 10, 10, 0                               
                            };
        ...
        private Boolean Check_TextBox_Error()
        {
            ...
            if (txtKey.Text.Trim() == "")
            {
                ...
                Tsql = Tsql + " From tbl_Nation  (nolock)  ";
                Tsql = Tsql + " Where upper(nationNameEng) = '" + ((txtData.Text).Trim()).ToUpper() + "'";
                Tsql = Tsql + " Order by nationCode ASC ";
                ...
                Tsql = "Select nationCode, nationNameEng ";
                Tsql = Tsql + " From tbl_Nation  (nolock)  ";
                Tsql = Tsql + " Where nationNameKo = '" + (txtData2.Text).Trim() + "'";
                Tsql = Tsql + " Order by nationCode ASC ";
            ...
            else
            {
                ...
                string Tsql;
                Tsql = "Select nationNameKo, nationNameEng ";
                Tsql = Tsql + " From tbl_Nation  (nolock)  ";
                Tsql = Tsql + " Where upper(nationNameEng) <> '" + ((txtKey.Text).Trim()).ToUpper() + "'";
                Tsql = Tsql + " And  nationNameKo = '" + (txtData2.Text).Trim() + "'";
                Tsql = Tsql + " Order by nationNameKo ASC ";
        ...
        private void Save_Base_Data(ref int Save_Error_Check)
        {
            ...
            if (radio_U_1.Checked == true) Using_TF = 1;
           ...
           if (txtKey.Text.Trim() == "" )
            {
                ...
                Tsql = "Insert Into tbl_Nation (nationCode , nationNameKo , nationNameEng , Using_TF ) Values (";
                Tsql = Tsql + "'" + txtData.Text.Trim() + "','" + txtData2.Text.Trim() + "','" + txtData3.Text.Trim() + "'," + Using_TF + " ) ";
            ...
            else //동일한 은행 코드가 있구나 그럼 업데이트
            {
                ...
                Tsql = "Update tbl_Nation Set ";
                Tsql = Tsql + " nationNameKo = '" + txtData2.Text.Trim() + "'";
                Tsql = Tsql + " ,Using_TF = " + Using_TF;
                Tsql = Tsql + " WHERE nationNameEng = '" + txtKey.Text.Trim() + "'";
        ...
        private Boolean Check_TextBox_Error(int i)
        {
            ...
            Tsql = Tsql + " Where Na_Code = '" + txtData.Text.Trim() + "'";
            ...
            Tsql = Tsql + " Where Na_Code = '" + txtData.Text.Trim() + "'";
            Tsql = Tsql + " Order by Na_code ASC ";
        ...
        private void dGridView_Base_DoubleClick(object sender, EventArgs e)
        {
            ...
            if ((sender as DataGridView).CurrentRow.Cells[0].Value != null)
            {
                ...
                txtData3.Text = (sender as DataGridView).CurrentRow.Cells[2].Value.ToString();

                if ((sender as DataGridView).CurrentRow.Cells[4].Value.ToString() == "1")
                {
                    radio_U_1.Checked = true;
                    radio_U_2.Checked = false;
                }
                else
                {
                    radio_U_1.Checked = false;
                    radio_U_2.Checked = true;
                }

                txtKey.Text = (sender as DataGridView).CurrentRow.Cells[2].Value.ToString();
            }
        }
