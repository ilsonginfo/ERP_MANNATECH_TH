...
{
    public partial class frmBase_Member_Search_hptel : clsForm_Extends
    {
        StringEncrypter encrypter = new StringEncrypter(cls_User.con_EncryptKey, cls_User.con_EncryptKeyIV);

        cls_Grid_Base cgb = new cls_Grid_Base();
        private const string base_db_name = "tbl_Memberinfo";
        //20191017 구현호대리 - 회원조회-핸드폰조회중복창
        ...
        public frmBase_Member_Search_hptel()
        {
            InitializeComponent();
        }
        ...
        private void Base_Grid_Set()
        {
            ...
            {
                sb.AppendLine(" And tbl_Memberinfo.hptel like '%" + txtMemberName.Text.Trim() + "%' ");
