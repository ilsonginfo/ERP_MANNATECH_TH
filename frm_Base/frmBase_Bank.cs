...
{
    public partial class frmBase_Bank :Form  
    {
        cls_Grid_Base cgb = new cls_Grid_Base();
        private const string base_db_name = "tbl_Bank";
        ...
        private void Base_Grid_Set()
        {
            ...
            string Tsql;
            Tsql = "Select Ncode, BankName, Isnull(nationNameEng,'') nationNameEng , Na_code  ";
            Tsql = Tsql + " From tbl_bank  (nolock)  ";
            Tsql = Tsql + " LEFT JOIN  tbl_Nation  (nolock) ON tbl_Nation.nationCode = tbl_bank.Na_Code  ";
            Tsql = Tsql + " Where tbl_bank.Na_Code in (Select Na_Code From ufn_User_In_Na_Code('" + cls_User.gid_CountryCode + "') )";
            //if (tab_Nation.Visible == true)
            //{
            //    if (combo_Se_Code.Text != "")
            //    {
            //        //Tsql = Tsql + " Where tbl_bank.Na_Code = '" + combo_Se_Code.Text + "'";
            //        Tsql = Tsql + " Where tbl_bank.Na_Code in (Select Na_Code From ufn_User_In_Na_Code('" + cls_User.gid_CountryCode + "') )";
            //    }
            //}
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = { "은행_코드" , "은행명"  , "소속국가"  ,""   , ""                                        
                                    };
        ...
        {      
            ...
            if (txtKey.Text.Trim() == "")
            {
                ...
                Tsql = "Select Ncode, BankName ";
                Tsql = Tsql + " From tbl_bank  (nolock)  ";
                Tsql = Tsql + " Where BankName = '" + (txtData2.Text).Trim() + "'";
                Tsql = Tsql + " And   Na_Code = '" + cls_User.gid_CountryCode + "'"; 
                Tsql = Tsql + " Order by Ncode ASC ";
            ...
            else
            {
                ...
                Tsql = Tsql + " From tbl_bank  (nolock)  ";
                Tsql = Tsql + " Where upper(Ncode) <> '" + ((txtData.Text).Trim()).ToUpper() + "'";
                Tsql = Tsql + " And  BankName = '" + (txtData2.Text).Trim() + "'";
                Tsql = Tsql + " And   Na_Code = '" + cls_User.gid_CountryCode + "'"; 
                Tsql = Tsql + " Order by Ncode ASC ";
        ...
        private void Save_Base_Data(ref int Save_Error_Check)
        {
            ...
            if (ReCnt == 0)//동일한 은행 코드가없네 그럼 인설트
            {
                ...
                Tsql = "Insert Into tbl_bank (Ncode , BankName , Na_Code ) Values (";
                ...
                //in_dic_1["@v_BankName"] = txtData2.Text.Trim();
                ...
                //in_dic_2["@v_BankName"] = SqlDbType.VarChar;                
            ...
            else //동일한 은행 코드가 있구나 그럼 업데이트
            {
                ...
                Tsql = "Update tbl_bank Set ";
                Tsql = Tsql + " BankName = '" + txtData2.Text.Trim() + "'";                
        ...
        private void Delete_Base_Data(ref int Del_Error_Check)
        {
            ...
            string Tsql;
            Tsql = "Delete From tbl_Bank ";
            Tsql = Tsql + " Where Ncode = '" + txtData.Text.Trim() + "'";
            //Tsql = Tsql + " And   Na_Code = '" + combo_Se_Code.Text.Trim() + "'";
            Tsql = Tsql + " And   Na_Code = ( Select Na_Code From ufn_User_In_Na_Code ('" + cls_User.gid_CountryCode + "') )";
        ...
        private Boolean Check_TextBox_Error(int i)
        {
            ...
            Tsql = Tsql + " Where BankCode = '" + txtData.Text.Trim() + "'";
            Tsql = Tsql + " And   Na_Code = '" + cls_User.gid_CountryCode + "'"; 
        ...
        private void dGridView_Base_DoubleClick(object sender, EventArgs e)
        {
            ...
            if ((sender as DataGridView).CurrentRow.Cells[0].Value != null)
            {
                ...
                {
                    string combo_Se_string = (sender as DataGridView).CurrentRow.Cells[2].Value.ToString();
                    combo_Se.Text = combo_Se_string;
                    string combo_Se_Code_string = (sender as DataGridView).CurrentRow.Cells[3].Value.ToString();
                    combo_Se_Code.Text = combo_Se_Code_string;
                }
