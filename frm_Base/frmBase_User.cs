...
namespace MLM_Program
{
    public partial class frmBase_User : clsForm_Extends
    {
        ...
        private void Save_Base_Data(ref int Save_Error_Check)
        {
            ...
            //int Return_Cacu_Cancel_FLAG = 0, Return_Cacu_Save_FLAG = 0;
            ...
            //if (chk_CC_Save.Checked == true) 2018-10-04 지성경 공동신청인_등록_권한을 무조건 주기로함
                CC_Save_TF = 1;
            ...
            if (chk_Cpno_V.Checked == true)
             ...
             //if (checkB_Return_Cacu_Save_FLAG.Checked == true)
                 //Return_Cacu_Save_FLAG = 1;

             //if (checkB_Return_Cacu_Cancel_FLAG.Checked == true)
                // Return_Cacu_Cancel_FLAG = 1;
            ...
            if (dic_tbl_User.ContainsKey(u_user_Ncode) == false)
            {
               ...
               // StrSql = StrSql + " , Return_Cacu_Save_FLAG, Return_Cacu_Cancel_FLAG ";
                ...
                //if (combo_Se_Code.Text == "")   //여기는 국가 관련 사항이 들어가면 안되기 때문에 빈칸으로 저장시킽다
                //    StrSql = StrSql + ",'KR'";
                //else
            ...
            else
            {
                ...
                ///Tsql = Tsql + " ,Return_Cacu_Save_FLAG= " + Return_Cacu_Save_FLAG;
                //Tsql = Tsql + " ,Return_Cacu_Cancel_FLAG= " + Return_Cacu_Cancel_FLAG;
        ...
        private void Set_Tbl_User(string Search_S = "", string Search_Check = "")
        {
            ...
            Tsql = Tsql + ", U_Dep ,  U_Pos , U_email , U_Dir_Phone , U_Entry_Date,U_Leave_Date "; //, Return_Cacu_Save_FLAG , Return_Cacu_Cancel_FLAG  ";
            ...
            for (int fi_cnt = 0; fi_cnt <= ReCnt - 1; fi_cnt++)
            {
                ...
                //t_User.Return_Cacu_Save_FLAG = int.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Return_Cacu_Save_FLAG"].ToString());
                //t_User.Return_Cacu_Cancel_FLAG = int.Parse(ds.Tables[base_db_name].Rows[fi_cnt]["Return_Cacu_Cancel_FLAG"].ToString());
        ...
        private void dGridView_Base_DoubleClick(object sender, EventArgs e)
        {
            ...
            tab_Menu.Refresh();
            //checkB_Return_Cacu_Save_FLAG.Checked = false;
            //checkB_Return_Cacu_Cancel_FLAG.Checked = false;
            ...
            if (((sender as DataGridView).CurrentRow != null) && ((sender as DataGridView).CurrentRow.Cells[0].Value != null))
            {
                ...
                //if (dic_tbl_User[u_user_Ncode].Return_Cacu_Cancel_FLAG == 1)
                    //checkB_Return_Cacu_Cancel_FLAG.Checked = true;

                //if (dic_tbl_User[u_user_Ncode].Return_Cacu_Save_FLAG == 1)
                    //checkB_Return_Cacu_Save_FLAG.Checked = true;
        ...
        private void button_D_Select_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                //if ( radioB_User_FLAG_S_T.Checked == false && radioB_User_FLAG_S_E.Checked == false)
                //{
