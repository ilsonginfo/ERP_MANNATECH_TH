...
{
    public partial class frmBase_Member_Search_NOM_SAVE_Fo : clsForm_Extends
    {
        ...
        public frmBase_Member_Search_NOM_SAVE_Fo()
        {
            InitializeComponent();
        }
        ...
        private void Base_Grid_Set()
        {
            ...
            if ((Search_Member_Number_Mbid == "") && (Search_Member_Number_Mbid2 != 0))
                sb.AppendLine("  exec [Usp_JDE_SELECT_NOM_SAVE_like_Fo] " + Search_Member_Number_Mbid2 + "");
            if ((txtMemberName.Text.Trim() != "") && (txtCpno.Text.Trim() == ""))
                sb.AppendLine("  exec [Usp_JDE_SELECT_NOM_SAVE_like_M_NAME_Fo] '" + txtMemberName.Text + "'");
