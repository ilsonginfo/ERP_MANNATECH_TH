...
namespace MLM_Program
{
    public partial class frmSMS_Member_Card : Form
    {
        ...
        private void dGridView_Base_Header_Reset()
        {
            ...
            string[] g_HeaderText = {"선택","회원_번호"  , "성명"   , "카드번호"    , "문구"        
        ...
        private void dGridView_Base_Header_2_Reset()
        {
            ...
            string[] g_HeaderText = {"선택","회원_번호"  , "성명"   , "핸드폰"  , "번호"
                                       ,"문구", "결과"        
        ...
        private void Sms_Send_Short(int rowCnt, ref int tempOK, ref int tempBad)
        {
            ...
            Temp_Connect.Open_SMSData_Set(strSQL, base_db_name, ds3);

            string MMSSeq = ds3.Tables[base_db_name].Rows[0][0].ToString(); 
        ...
        {
            Dictionary<int, object[]> gr_dic_text = new Dictionary<int, object[]>();
            string Mbid = "", M_Name = "", hptel = "", num= "", msg;
            ...
            for (int i = 0; i <= dGridView_Base_Excel.Rows.Count - 2; i++)
            {
                ...
                num = dGridView_Base_Excel.Rows[i].Cells[3].Value.ToString();
                msg = dGridView_Base_Excel.Rows[i].Cells[4].Value.ToString();
                ...
                if (hptel.Replace ("-","") != "" && (hptel.Substring(0, 3) == "010" || hptel.Substring(0, 3) == "011" || hptel.Substring(0, 3) == "016" || hptel.Substring(0, 3) == "017" || hptel.Substring(0, 3) == "018" || hptel.Substring(0, 3) == "019"))
                {
                    ...
                    //if (SW == 0)
                    //{
                        object[] row0 = { "V", Mbid, M_Name, hptel,num, msg,"" };
                        cgb_2.basegrid.Rows.Add(row0);
                        //dGridView_Base_Excel.Rows[i].Visible = false;
                    //}
                }
        ...
        private void butt_Select_Click(object sender, EventArgs e)
        {
