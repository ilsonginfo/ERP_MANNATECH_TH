...
namespace MLM_Program
{
    public partial class frmSell_Select_Group_Date_Sell_Cen : Form
    {
        ...
        public frmSell_Select_Group_Date_Sell_Cen()
        {
            InitializeComponent();
        }
        ...
        private void frmBase_From_Load(object sender, EventArgs e)
        {
            ...
            txt_PP_8.BackColor = cls_app_static_var.txt_Enable_Color;
        ...
        {   
            ...
            if (combo_Sort.SelectedIndex == 0)
            {
                Tsql = Tsql + " Group By tbl_SalesDetail.SellDate,tbl_SalesDetail.SellDate_2, tbl_Business.ncode , isnull(tbl_Business.name,'') ";
                Tsql = Tsql + " Order By tbl_SalesDetail.SellDate ,tbl_SalesDetail.SellDate_2,  tbl_Business.ncode , isnull(tbl_Business.name,'') ";
            }

            if (combo_Sort.SelectedIndex == 1)
            {
                Tsql = Tsql + " Group By LEFT(tbl_SalesDetail.SellDate,6) , LEFT(tbl_SalesDetail.SellDate_2,6) , tbl_Business.ncode , isnull(tbl_Business.name,'') ";
                Tsql = Tsql + " Order By LEFT(tbl_SalesDetail.SellDate,6) , LEFT(tbl_SalesDetail.SellDate_2,6),tbl_Business.ncode , isnull(tbl_Business.name,'') ";
            }


            if (combo_Sort.SelectedIndex == 2)
            {
                Tsql = Tsql + " Group By LEFT(tbl_SalesDetail.SellDate,4) ,LEFT(tbl_SalesDetail.SellDate,4), tbl_Business.ncode , isnull(tbl_Business.name,'') ";
                Tsql = Tsql + " Order By LEFT(tbl_SalesDetail.SellDate,4) ,LEFT(tbl_SalesDetail.SellDate,4), tbl_Business.ncode , isnull(tbl_Business.name,'') ";
            }
            ...
            string Base_Date = ""; string Cen_Name = ""; double Cen_PR = 0;
            double Sum_04 = 0; double Sum_05 = 0; double Sum_09 = 0; double Sum_10 = 0, Sum_11 = 0;
            double Sum_06 = 0; double Sum_07 = 0; double Sum_08 = 0;
            ...
            for (int fi_cnt = 0; fi_cnt <= ReCnt - 1; fi_cnt++)
            {
                ...
                Sum_11 = Sum_11 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][6].ToString());
                Sum_06 = Sum_06 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][7].ToString());
                Sum_07 = Sum_07 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][8].ToString());
                Sum_08 = Sum_08 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][9].ToString());
                Sum_09 = Sum_09 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][11].ToString());
            ...
            if (gr_dic_text.Count > 0)
                ...
                txt_P_5.Text = string.Format(cls_app_static_var.str_Currency_Type, Sum_08);
                txt_P_6.Text = string.Format(cls_app_static_var.str_Currency_Type, Sum_09);       
                txt_P_7.Text = string.Format(cls_app_static_var.str_Currency_Type, Sum_10);
                txt_P_8.Text = string.Format(cls_app_static_var.str_Currency_Type, Sum_11);
                ...
                //    //if (Base_Date == "") Base_Date = "무";
                //    //series_Day.Name = Base_Date;
        ...
        private void Base_Button_Click(object sender, EventArgs e)
        {
            ...
            if (bt.Name == "butt_Clear")
            {
                ...
                ct.from_control_clear(this, mtxtSellDate3);
        ...
        {
            Excel_Export_File_Name = this.Text; // "Sell_Group_Date_Center";
        ...
        private void dGridView_Base_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                string Sell_Cen = ""; string SellDate = "";
                SellDate = (sender as DataGridView).CurrentRow.Cells[0].Value.ToString();
                Sell_Cen = (sender as DataGridView).CurrentRow.Cells[2].Value.ToString();
                this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
                Item_Grid_Set(SellDate, Sell_Cen);
                this.Cursor = System.Windows.Forms.Cursors.Default; 
            }            
        }
        ...
        private void Item_Grid_Set(string SellDate, string Sell_Bus)
        {
            ...
            Tsql = Tsql + " And  tbl_SalesDetail.BusCode = '" + Sell_Bus + "'";
            ...
            double Sum_10 = 0; double Sum_11 = 0; double Sum_12 = 0; double Sum_13 = 0, Sum_14= 0;
            ...
            for (int fi_cnt = 0; fi_cnt <= ReCnt - 1; fi_cnt++)
            {
                ...
                Sum_14 = Sum_14 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][8].ToString());
            ...
            if (gr_dic_text.Count > 0)
            {
                ...
                txt_PP_8.Text = string.Format(cls_app_static_var.str_Currency_Type, Sum_14);
            }
