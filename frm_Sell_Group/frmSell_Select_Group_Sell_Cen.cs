...
{
    public partial class frmSell_Select_Group_Sell_Cen : clsForm_Extends
    {
        ...
        public frmSell_Select_Group_Sell_Cen()
        {
            InitializeComponent();
        }
        ...
        {   
            ...
            double Sum_06 = 0; double Sum_07 = 0; double Sum_08 = 0; double Sum_09 = 0, Sum_10= 0 ;
            //double Sum_16 = 0;
            ...
            if (gr_dic_text.Count > 0)
            {
                ...
                txt_P_8.Text = string.Format(cls_app_static_var.str_Currency_Type, Sum_10);                
            }
        ...
        private void Base_Button_Click(object sender, EventArgs e)
        {
            ...
            else if (bt.Name == "butt_Select")
            {
                ...
                txt_PP_3.Text = ""; txt_PP_4.Text = ""; txt_PP_5.Text = ""; txt_PP_7.Text = ""; txt_PP_8.Text = "";

                txt_P_1.Text = ""; txt_P_2.Text = ""; txt_P_3.Text = "";
                txt_P_4.Text = ""; txt_P_5.Text = ""; txt_P_6.Text = ""; txt_P_7.Text = ""; txt_P_8.Text = "";
                //<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        {
            Excel_Export_File_Name = this.Text; // "Sell_Group_SellCenter";
        ...
        private void Item_Grid_Set(string ItemCode )
        {
            ...
            Tsql = Tsql + " ,Isnull((Select  ";
            Tsql = Tsql + "  Top 1 Case When Receive_Method = '1' Then '" + cm._chang_base_caption_search("직접수령") + "'";
            ...
            Tsql = Tsql + " ELSE '' End  From tbl_Sales_Rece (nolock) Where tbl_Sales_Rece.OrderNumber = tbl_SalesDetail.OrderNumber Order by Salesitemindex ASC ) ,'') Rec_M ";
            ...
            Tsql = Tsql + " And  tbl_SalesDetail.BusCode = '" + ItemCode + "'";
            ...
            for (int fi_cnt = 0; fi_cnt <= ReCnt - 1; fi_cnt++)
            {
                ...
                Sum_07 = Sum_07 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][6].ToString()); //TOTALPRICE
                Sum_08 = Sum_08 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][7].ToString());//TOTALPV
