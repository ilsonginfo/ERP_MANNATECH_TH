...
{
    public partial class frmSell_Select_Group_Mem_Cen_Item : clsForm_Extends
    {
        ...
        public frmSell_Select_Group_Mem_Cen_Item()
        {
            InitializeComponent();
        }
        ...
        {
            Excel_Export_File_Name = this.Text; // "Sell_Group_Center_Item";
        ...
        private void Item_Grid_Set(string Mem_Cen, string ItemCode )
        {
            ...
            Tsql = Tsql + " And  tbl_Memberinfo.BusinessCode = '" + Mem_Cen + "'";
        ...
        //    series_Item.Name = cm._chang_base_caption_search("회원센타별");
