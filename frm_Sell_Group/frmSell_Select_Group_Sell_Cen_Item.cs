...
{
    public partial class frmSell_Select_Group_Sell_Cen_Item : clsForm_Extends
    {
        ...
        public frmSell_Select_Group_Sell_Cen_Item()
        {
            InitializeComponent();
        }
       ...
       //     strSql = strSql + " And tbl_Memberinfo.BusinessCode in ( Select Center_Code From ufn_User_In_Center ('" + cls_User.gid_CenterCode + "','" + cls_User.gid_CountryCode  + "') )";
        ...
        {   
            ...
            double Sum_05 = 0; double Sum_06 = 0; double Sum_07 = 0 , Sum_08 = 0 ;
            ...
            if (gr_dic_text.Count > 0)
                {
                    txt_P_1.Text = string.Format(cls_app_static_var.str_Currency_Type, Sum_05);     //204
                    txt_P_2.Text = string.Format(cls_app_static_var.str_Currency_Type, Sum_06);  //44516000
                    txt_P_3.Text = string.Format(cls_app_static_var.str_Currency_Type, Sum_07);   //32027300
                    txt_P_7.Text = string.Format(cls_app_static_var.str_Currency_Type, Sum_08);  //15718700
                }
        ...
        private void Base_Button_Click(object sender, EventArgs e)
        {
            ...
            else if (bt.Name == "butt_Select")
            {
                ...
                txt_P_1.Text = ""; txt_P_2.Text = ""; txt_P_3.Text = ""; txt_P_7.Text = "";
                chart_Item.Series.Clear();
                tabControl_Tab_Dispose();
                //<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        {
            Excel_Export_File_Name = this.Text; // "Sell_Group_SellCenter_Item";
        ...
        private void Item_Grid_Set(string Mem_Cen, string ItemCode )
        {
            ...
            for (int fi_cnt = 0; fi_cnt <= ReCnt - 1; fi_cnt++)
            {
                ...
                Sum_09 = Sum_09 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][9].ToString()); //2
                Sum_10 = Sum_10 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][10].ToString()); //158000
                Sum_11 = Sum_11 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][11].ToString());//94800
                Sum_12 = Sum_12 + double.Parse(ds.Tables[base_db_name].Rows[fi_cnt][12].ToString());//55400
            }
